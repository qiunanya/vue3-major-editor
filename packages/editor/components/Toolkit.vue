<template>
    <div class="vue3-major-editor__toolbar" data-major-editor="true">
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button :style="{ cursor: !isUndo ? 'not-allowed' : 'pointer' }" data-major-editor-toolbar="toolbar-btn_item"
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button :style="{ cursor: !isRedo ? 'not-allowed' : 'pointer' }" data-major-editor-toolbar="toolbar-btn_item"
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item" @click="handleClearContent">
                    <svg viewBox="0 0 1024 1024" width="200" height="200">
                        <path
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item" @click="handleTextStyle('Bold')">
                    <svg viewBox="0 0 1024 1024" width="200" height="200">
                        <path
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('Underline')">
                    <svg viewBox="0 0 1024 1024" width="200" height="200">
                        <path
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item" @click="handleTextStyle('Code')">
                    <svg viewBox="0 0 1024 1024" width="200" height="200">
                        <path
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('CodeBlock')">
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('Blockquote')">
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('OrderedList')">
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('BulletList')">
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('HorizontalRule')">
                    <svg viewBox="0 0 1024 1024" width="200" height="200">
                        <path
        ...
        <NTooltip placement="bottom" trigger="hover">
            <template #trigger>
                <button class="is-active" data-major-editor-toolbar="toolbar-btn_item"
                    @click="handleTextStyle('Paragraph')">
                    <svg viewBox="0 0 1024 1024" width="200" height="200">
                        <path
        ...
        <NPopselect v-model:value="selectLineHeight" trigger="hover" :options="lineHeightOptions" :on-update:value="handleLineHeight">
            <NTooltip placement="top" trigger="hover">
                <template #trigger>
                    <button class="is-active" data-major-editor-toolbar="toolbar-btn_item">
                        <svg viewBox="0 0 1097 1024" width="200" height="200">
