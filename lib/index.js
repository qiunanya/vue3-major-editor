...
var _c = (n, e, t) => e in n ? jc(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var et = (n, e, t) => _c(n, typeof e != "symbol" ? e + "" : e, t);
import { defineComponent as Be, ref as Wr, onMounted as Cl, onBeforeUnmount as qr, h as Rt, reactive as Wc, markRaw as qc, getCurrentInstance as Kc, watchEffect as Jc, nextTick as Uc, unref as zi, Teleport as Gc, customRef as Yc, inject as ci, openBlock as fs, createElementBlock as hs, createElementVNode as Me, createStaticVNode as ps, pushScopeId as Xc, popScopeId as Zc, createVNode as Vi, useModel as Qc, provide as ui } from "vue";
function Q(n) {
  this.content = n;
}
Q.prototype = {
...
function Ol(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || s.content.size) {
      let o = Ol(i.content, s.content, t + 1);
      if (o != null)
        return o;
    }
    t += i.nodeSize;
...
function Tl(n, e, t, r) {
  for (let i = n.childCount, s = e.childCount; ; ) {
    ...
    if (o.content.size || l.content.size) {
      let c = Tl(o.content, l.content, t - 1, r - 1);
      if (c)
        return c;
    }
    t -= a, r -= a;
...
x.empty = new x([], 0);
const di = { index: 0, offset: 0 };
function mr(n, e) {
  return di.index = n, di.offset = e, di;
}
function Tr(n, e) {
  if (n === e)
    return !0;
...
class S {
  ...
  */
  removeBetween(e, t) {
    return new S(El(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function El(n, e, t) {
  ...
  if (r != o)
    throw new RangeError("Removing non-flat range");
  return n.replaceChild(r, s.copy(El(s.content, e - i - 1, t - i - 1)));
}
function Al(n, e, t, r) {
...
function Nl(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: o, end: l } = tu(t, n);
      return Lt(s, Il(n, o, l, e, r));
    }
  else return Lt(s, Ar(n, e, r));
}
function Dl(n, e) {
...
function Il(n, e, t, r, i) {
  ...
  return Rn(null, n, i, l), s && o && e.index(i) == t.index(i) ? (Dl(s, o), Pt(Lt(s, Il(n, e, t, r, i + 1)), l)) : (s && Pt(Lt(s, Ar(n, e, i + 1)), l), Rn(e, t, i, l), o && Pt(Lt(o, Ar(t, r, i + 1)), l)), Rn(r, null, i, l), new x(l);
}
function Ar(n, e, t) {
  let r = [];
  if (Rn(null, n, t, r), n.depth > t) {
    let i = Hi(n, e, t + 1);
    Pt(Lt(i, Ar(n, e, t + 1)), r);
  }
  return Rn(e, null, t, r), new x(r);
}
function tu(n, e) {
...
let Bt = class $i {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Tr(this.attrs, t || e.defaultAttrs || ru) && F.sameSet(this.marks, r || F.none);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return eu(this.resolve(e), this.resolve(t), r);
  }
  /**
...
let Js = class Fl {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Vl(r.attrs), this.defaultAttrs = Bl(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : zl(this.attrs, e);
  }
  /**
  ...
  */
  create(e = null, t, r) {
    ...
    return new Bt(this, this.computeAttrs(e), x.from(t), F.setFrom(r));
  }
  /**
  ...
  */
  createChecked(e = null, t, r) {
    return t = x.from(t), this.checkContent(t), new Bt(this, this.computeAttrs(e), t, F.setFrom(r));
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((s, o) => r[s] = new Fl(s, t, o));
...
class Kr {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = Vl(i.attrs), this.excluded = null;
    let s = Bl(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new F(this, zl(this.attrs, e));
  }
  /**
  @internal
  */
...
class pu {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = Q.from(e.nodes), t.marks = Q.from(e.marks || {}), this.nodes = Js.compile(this.spec.nodes, this), this.marks = Kr.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
    for (let i in this.nodes) {
      ...
      s.markSet = l == "_" ? null : l ? Us(this, l.split(" ")) : l == "" || !s.inlineContent ? [] : null;
    }
    for (let i in this.marks) {
      let s = this.marks[i], o = s.spec.excludes;
      s.excluded = o == null ? [s] : o == "" ? [] : Us(this, o.split(" "));
    }
  ...
  */
  constructor(e, t) {
    this.schema = e, this.rules = t, this.tags = [], this.styles = [], t.forEach((r) => {
      mu(r) ? this.tags.push(r) : gu(r) && this.styles.push(r);
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let s = this.tags[i];
      if (bu(e, s.tag) && (s.namespace === void 0 || e.namespaceURI == s.namespace) && (!s.context || t.matchesContext(s.context))) {
        if (s.getAttrs) {
          let o = s.getAttrs(e);
          if (o === !1)
            continue;
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      s && s.forEach((o) => {
        r(o = Xs(o)), o.mark || o.ignore || o.clearMark || (o.mark = i);
      });
    }
    for (let i in e.nodes) {
      let s = e.nodes[i].spec.parseDOM;
      s && s.forEach((o) => {
        r(o = Xs(o)), o.node || o.ignore || o.mark || (o.node = i);
      });
    }
    return t;
  }
...
const Hl = {
  ...
  style: !0,
  title: !0
}, $l = { ol: !0, ul: !0 }, Ir = 1, Rr = 2, Pn = 4;
function Gs(n, e, t) {
  return e != null ? (e ? Ir : 0) | (e === "full" ? Rr : 0) : n && n.whitespace == "pre" ? Ir | Rr : t & ~Pn;
}
class gr {
  constructor(e, t, r, i, s, o, l) {
    this.type = e, this.attrs = t, this.marks = r, this.pendingMarks = i, this.solid = s, this.options = l, this.content = [], this.activeMarks = F.none, this.stashMarks = [], this.match = o || (l & Pn ? null : e.contentMatch);
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type)
...
class Ys {
  constructor(e, t, r) {
    ...
    let i = t.topNode, s, o = Gs(null, t.preserveWhitespace, 0) | (r ? Pn : 0);
    i ? s = new gr(i.type, i.attrs, F.none, F.none, !0, t.topMatch || i.type.contentMatch, o) : r ? s = new gr(null, null, F.none, F.none, !0, null, o) : s = new gr(e.schema.topNodeType, null, F.none, F.none, !0, null, o), this.nodes = [s], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
  ...
  addTextNode(e) {
    ...
    if (r.options & Rr || r.inlineContext(e) || /[^ \t\r\n\u000c]/.test(t)) {
      if (r.options & Ir)
        r.options & Rr ? t = t.replace(/\r\n?/g, `
`) : t = t.replace(/\r?\n|\r/g, " ");
...
`));
  ...
  enterInner(e, t = null, r = !1, i) {
    ...
    let o = Gs(e, i, s.options);
    s.options & Pn && s.content.length == 0 && (o |= Pn), this.nodes.push(new gr(e, t, s.activeMarks, s.pendingMarks, r, null, o)), this.open++;
  }
...
function vu(n) {
  for (let e = n.firstChild, t = null; e; e = e.nextSibling) {
    ...
    r && $l.hasOwnProperty(r) && t ? (t.appendChild(e), e = t) : r == "li" ? t = e : r && (t = null);
  }
}
function bu(n, e) {
...
class _e {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = _e.renderSpec(pi(t), this.nodes[e.type.name](e));
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && _e.renderSpec(pi(r), i(e, t));
  }
  /**
  ...
  static renderSpec(e, t, r = null) {
    ...
    for (let u = c; u < t.length; u++) {
      ...
      if (d === 0) {
        ...
        let { dom: f, contentDOM: h } = _e.renderSpec(e, d, r);
...
const jl = 65535, _l = Math.pow(2, 16);
function wu(n, e) {
  return n + e * _l;
}
function Qs(n) {
...
class ji {
  ...
  */
  get deletedBefore() {
    return (this.delInfo & (Wl | wr)) > 0;
  }
  /**
  True when the token after the mapped position was deleted.
  */
  get deletedAfter() {
    return (this.delInfo & (ql | wr)) > 0;
  }
  /**
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : d) ? null : wu(l / 3, e - a), m = e == a ? ql : e == d ? Wl : wr;
        return (t < 0 ? e != a : e != d) && (m |= Kl), new ji(h, m, p);
      }
      i += u - c;
    }
...
class ht extends le {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), s = new S(ms(t.content, (o, l) => !o.isAtom || !l.type.allowsMarkType(this.mark.type) ? o : o.mark(this.mark.addToSet(o.marks)), i), t.openStart, t.openEnd);
...
class We extends le {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new S(ms(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class U extends le {
  ...
  */
  ...
  apply(e) {
    return this.structure && _i(e, this.from, this.to) ? q.fail("Structure replace would overwrite content") : q.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
class G extends le {
  ...
  */
  ...
  apply(e) {
    if (this.structure && (_i(e, this.from, this.gapFrom) || _i(e, this.gapTo, this.to)))
...
function Jl(n, e, t, r = t.contentMatch, i = !0) {
...
function xn(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(s, o, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !Ou(i, s, o))
      break;
  }
  return null;
}
...
function gs(n, e, t = null, r = n) {
  let i = Eu(n, e), s = i && Au(r, e);
  return s ? i.map(eo).concat({ type: e, attrs: t }).concat(s.map(eo)) : null;
}
function eo(n) {
...
function Du(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (o, l) => {
    if (o.isTextblock && !o.hasMarkup(r, i) && Pu(n.doc, n.mapping.slice(s).map(l), r)) {
      let a = null;
      if (r.schema.linebreakReplacement) {
        let f = r.whitespace == "pre", h = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        f && !h ? a = !1 : !f && h && (a = !0);
      }
      a === !1 && Ru(n, o, l, s), Jl(n, n.mapping.slice(s).map(l, 1), r, void 0, a === null);
      let c = n.mapping.slice(s), u = c.map(l, 1), d = c.map(l + o.nodeSize, 1);
      return n.step(new G(u, d, u + 1, d - 1, new S(x.from(r.create(i, null, o.marks)), 0, 0), 1, !0)), a === !0 && Iu(n, o, l, s), !1;
    }
  });
}
function Iu(n, e, t, r) {
...
function kt(n, e) {
  ...
  return Ul(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function Ul(n, e) {
...
function Jr(n, e, t = -1) {
  ...
  for (let i = r.depth; ; i--) {
    let s, o, l = r.index(i);
    if (i == r.depth ? (s = r.nodeBefore, o = r.nodeAfter) : t > 0 ? (s = r.node(i + 1), l++, o = r.node(i).maybeChild(l)) : (s = r.node(i).maybeChild(l - 1), o = r.node(i + 1)), s && !s.isTextblock && Ul(s, o) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function Ur(n, e, t = e, r = S.empty) {
  ...
  return Yl(i, s, r) ? new U(e, t, r) : new Fu(i, s, r).fit();
}
function Yl(n, e, t) {
...
class Fu {
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i, s = null;
        r ? (s = gi(this.unplaced.content, r - 1).firstChild, i = s.content) : i = this.unplaced.content;
        let o = i.firstChild;
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: r } = this.unplaced, i = gi(e, t);
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new S(Nn(e, t - 1, 1), t - 1, s ? t - 1 : r);
    } else
      this.unplaced = new S(Nn(e, t, 1), t, r);
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: s }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!y)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (d = y, u.push(Xl(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
    let p = c == l.childCount;
    p || (h = -1), this.placed = Dn(this.placed, t, x.from(u)), this.frontier[t].match = d, p && h < 0 && r && r.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
    for (let m = 0, y = l; m < h; m++) {
      let v = y.lastChild;
      this.frontier.push({ type: v.type, match: v.contentMatchAt(v.childCount) }), y = v.content;
    }
    this.unplaced = p ? e == 0 ? S.empty : new S(Nn(o.content, e - 1, 1), e - 1, h < 0 ? o.openEnd : e - 1) : new S(Nn(o.content, e, c), o.openStart, o.openEnd);
  }
  mustMoveInline() {
    if (!this.$to.parent.isTextblock)
      return -1;
    let e = this.frontier[this.depth], t;
    if (!e.type.isTextblock || !yi(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: r, type: i } = this.frontier[t], s = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), o = yi(e, t, i, r, s);
      if (o) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], u = yi(e, l, c, a, !0);
          if (!u || u.childCount)
            continue e;
        }
  ...
  openFrontierNode(e, t = null, r) {
    ...
    i.match = i.match.matchType(e), this.placed = Dn(this.placed, this.depth, x.from(e.create(t, r))), this.frontier.push({ type: e, match: e.contentMatch });
  }
  closeFrontierNode() {
...
function Xl(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, Xl(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)))), n.copy(r);
}
    ...
    if (p)
      for (let m = 0; m < o.length; m++) {
        ...
        if (w.canReplaceWith(C, C, p.type, p.marks))
          return n.replace(i.before(y), v ? s.after(y) : t, new S(Zl(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function Zl(n, e, t, r, i) {
  if (e < t) {
    let s = n.firstChild;
    n = n.replaceChild(0, s.copy(Zl(s.content, e + 1, t, r, s)));
  }
  if (e > r) {
...
function _u(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = Vu(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new S(x.from(r), 0, 0));
}
function Wu(n, e, t) {
  let r = n.doc.resolve(e), i = n.doc.resolve(t), s = Ql(r, i);
  for (let o = 0; o < s.length; o++) {
...
class P {
  ...
  */
  replace(e, t = S.empty) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      e.replaceRange(u.map(a.pos), u.map(c.pos), l ? S.empty : t), l == 0 && ro(e, s, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let s = 0; s < i.length; s++) {
      ...
      s ? e.deleteRange(c, u) : (e.replaceRangeWith(c, u, t), ro(e, r, t.isInline ? -1 : 1));
    }
  }
  /**
  ...
  */
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new I(e) : Qt(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
  ...
  */
  static atEnd(e) {
    return Qt(e, e, e.content.size, e.childCount, -1) || new Re(e);
  }
  /**
...
class Uu extends qu {
  ...
  */
  setSelection(e) {
    ...
    return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | io) & ~yr, this.storedMarks = null, this;
  }
  /**
  ...
  */
  scrollIntoView() {
    return this.updated |= so, this;
  }
  /**
  True when this transaction has had `scrollIntoView` called on it.
  */
  get scrolledIntoView() {
    return (this.updated & so) > 0;
  }
}
function oo(n, e) {
...
class In {
  constructor(e, t, r) {
    this.name = e, this.init = oo(t.init, r), this.apply = oo(t.apply, r);
  }
}
const Gu = [
  new In("doc", {
...
class bi {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = Gu.slice(), t && t.forEach((r) => {
      ...
      this.plugins.push(r), this.pluginsByKey[r.key] = r, r.spec.state && this.fields.push(new In(r.key, r.spec.state, r));
    });
  }
}
class nn {
  ...
  */
  applyInner(e) {
    ...
    let t = new nn(this.config), r = this.config.fields;
  ...
  */
  static create(e) {
    let t = new bi(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new nn(t);
  ...
  */
  reconfigure(e) {
    let t = new bi(this.schema, e.plugins), r = t.fields, i = new nn(t);
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new bi(e.schema, e.plugins), s = new nn(i);
...
function ea(n, e, t) {
  for (let r in n) {
    let i = n[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = ea(i, e, {})), t[r] = i;
  }
  return t;
}
class ge {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && ea(e.props, this, this.props), this.key = e.key ? e.key.key : ta("plugin");
  }
  /**
...
const nt = function(n, e, t) {
  ...
  return t && (lo(n, e, t, r, -1) || lo(n, e, t, r, 1));
...
function lo(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : je(n))) {
      let s = n.parentNode;
      if (!s || s.nodeType != 1 || Zn(n) || Xu.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = ee(n) + (i < 0 ? 0 : 1), n = s;
...
const Yr = function(n) {
  return n.focusNode && jt(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset);
};
function At(n, e) {
...
const Ke = typeof navigator < "u" ? navigator : null, ao = typeof document < "u" ? document : null, xt = Ke && Ke.userAgent || "", qi = /Edge\/(\d+)/.exec(xt), na = /MSIE \d/.exec(xt), Ki = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(xt), he = !!(na || Ki || qi), gt = na ? document.documentMode : Ki ? +Ki[1] : qi ? +qi[1] : 0, Pe = !he && /gecko\/(\d+)/i.test(xt);
Pe && +(/Firefox\/(\d+)/.exec(xt) || [0, 0])[1];
const Ji = !he && /Chrome\/(\d+)/.exec(xt), ce = !!Ji, rd = Ji ? +Ji[1] : 0, ue = !he && !!Ke && /Apple Computer/.test(Ke.vendor), hn = ue && (/Mobile\/\w+/.test(xt) || !!Ke && Ke.maxTouchPoints > 2), Se = hn || (Ke ? /Mac/.test(Ke.platform) : !1), id = Ke ? /Win/.test(Ke.platform) : !1, De = /Android \d/.test(xt), Qn = !!ao && "webkitFontSmoothing" in ao.documentElement.style, sd = Qn ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function od(n) {
...
function co(n, e, t) {
  ...
  for (let o = t || n.dom; o; o = jn(o)) {
    if (o.nodeType != 1)
      continue;
    let l = o, a = l == s.body, c = a ? od(s) : ld(l), u = 0, d = 0;
...
function ad(n) {
  ...
  return { refDOM: r, refTop: i, stack: ra(n.dom) };
}
function ra(n) {
...
function sa(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? dd(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: s } : sa(t, i);
}
function dd(n, e) {
...
function hd(n, e, t) {
  let { node: r, offset: i } = sa(e, t), s = -1;
...
function md(n, e) {
  ...
  if (o = fd(o, e), r) {
    ...
    let c;
    Qn && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = pd(n, r, i, e));
  }
  l == null && (l = hd(n, o, e));
...
function ct(n, e) {
  ...
  return Array.prototype.find.call(t, uo) || n.getBoundingClientRect();
}
const gd = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function la(n, e, t) {
  let { node: r, offset: i, atom: s } = n.docView.domFromPos(e, t < 0 ? -1 : 1), o = Qn || Pe;
  if (r.nodeType == 3)
    if (o && (gd.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = ct(nt(r, i, i), t);
      ...
      return t < 0 && !i ? (c++, u = -1) : t >= 0 && i == r.nodeValue.length ? (a--, u = 1) : t < 0 ? a-- : c++, En(ct(nt(r, a, c), u), u < 0);
    }
  if (!n.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && i && (t < 0 || i == je(r))) {
      let a = r.childNodes[i - 1];
      if (a.nodeType == 1)
        return xi(a.getBoundingClientRect(), !1);
    }
    if (s == null && i < je(r)) {
      let a = r.childNodes[i];
      if (a.nodeType == 1)
        return xi(a.getBoundingClientRect(), !0);
    }
    return xi(r.getBoundingClientRect(), t >= 0);
  }
  if (s == null && i && (t < 0 || i == je(r))) {
    let a = r.childNodes[i - 1], c = a.nodeType == 3 ? nt(a, je(a) - (o ? 0 : 1)) : a.nodeType == 1 && (a.nodeName != "BR" || !a.nextSibling) ? a : null;
    if (c)
      return En(ct(c, 1), !1);
  }
  if (s == null && i < je(r)) {
  ...
  return En(ct(r.nodeType == 3 ? nt(r) : r, -t), t >= 0);
}
function En(n, e) {
  if (n.width == 0)
    return n;
...
function bd(n, e, t) {
  ...
  return !vd.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? s : o : aa(n, e, () => {
...
let fo = null, ho = null, po = !1;
function kd(n, e, t) {
  return fo == e && ho == t ? po : (fo = e, ho = t, po = t == "up" || t == "down" ? yd(n, e, t) : bd(n, e, t));
}
const Oe = 0, mo = 1, Dt = 2, Je = 3;
class er {
  constructor(e, t, r, i) {
  ...
  domFromPos(e, t) {
    ...
    for (let s; r && !(s = this.children[r - 1]).size && s instanceof ca && s.side >= 0; r--)
      ;
    if (t <= 0) {
      let s, o = !0;
...
`), u && h == f.nodeValue.length)
    ...
    if (Pe && c.focusNode && c.focusNode != a.node && c.focusNode.nodeType == 1) {
      let f = c.focusNode.childNodes[c.focusOffset];
      f && f.contentEditable == "false" && (i = !0);
    }
    if (!(i || u && ue) && jt(l.node, l.offset, c.anchorNode, c.anchorOffset) && jt(a.node, a.offset, c.focusNode, c.focusOffset))
      return;
    let d = !1;
    if ((c.extend || e == t) && !u) {
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == o ? e <= o && t >= r : e < o && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == o ? Dt : mo, e == l && t == a && (s.contentLost || s.dom.parentNode != this.contentDOM) ? s.dirty = Je : s.markDirty(e - l, t - l);
          return;
        } else
          s.dirty = s.dom == s.contentDOM && s.dom.parentNode == this.contentDOM && !s.children.length ? Dt : Je;
      }
      r = o;
    }
    this.dirty = Dt;
...
class _t extends er {
  ...
  static create(e, t, r, i) {
    ...
    return (!o || !o.dom) && (o = _e.renderSpec(document, t.type.spec.toDOM(t, r))), new _t(e, t, o.dom, o.contentDOM || o.dom);
  }
  parseRule() {
  ...
  slice(e, t, r) {
    ...
    t < o && (s = Yi(s, t, o, r)), e > 0 && (s = Yi(s, 0, e, r));
...
class yt extends er {
  ...
  static create(e, t, r, i, s, o) {
    ...
    } else u || ({ dom: u, contentDOM: d } = _e.renderSpec(document, t.type.spec.toDOM(t)));
    !d && !t.isText && u.nodeName != "BR" && (u.hasAttribute("contenteditable") || (u.contentEditable = "false"), t.type.spec.draggable && (u.draggable = !0));
    let f = u;
    return u = ha(u, r, t), c ? a = new wd(e, t, r, i, u, d || null, f, c, s, o + 1) : t.isText ? new Xr(e, t, r, i, u, f, s) : new yt(e, t, r, i, u, d || null, f, s, o + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == Oe && e.eq(this.node) && Gi(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, s = e.composing ? this.localCompositionInfo(e, t) : null, o = s && s.pos > -1 ? s : null, l = s && s.pos < 0, a = new Md(this, o && o.node, e);
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == Dt) && (o && this.protectLocalComposition(e, o), da(this.contentDOM, this.children, e), hn && Ed(this.dom));
  }
  ...
  protectLocalComposition(e, { node: t, pos: r, text: i }) {
    ...
    let o = new xd(this, s, t, i);
    e.input.compositionNodes.push(o), this.children = Yi(this.children, r, r + i.length, e, o);
  }
  ...
  updateOuterDeco(e) {
    if (Gi(e, this.outerDeco))
      return;
    let t = this.nodeDOM.nodeType != 1, r = this.dom;
    this.dom = fa(this.dom, this.nodeDOM, Ui(this.outerDeco, this.node, t), Ui(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function go(n, e, t, r, i) {
  ha(r, e, n);
  let s = new yt(void 0, n, e, t, r, r, r, i, 0);
...
class Xr extends yt {
  ...
  update(e, t, r, i) {
    return this.dirty == Je || this.dirty != Oe && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != Oe || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, i.trackWrites == this.nodeDOM && (i.trackWrites = null)), this.node = e, this.dirty = Oe, !0);
  }
  inParent() {
...
function da(n, e, t) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (o instanceof _t) {
      ...
      da(o.contentDOM, o.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = yo(r), i = !0;
...
function ha(n, e, t) {
  return fa(n, n, It, Ui(e, t, n.nodeType != 1));
}
function Gi(n, e) {
  if (n.length != e.length)
    return !1;
...
class Md {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = Cd(e.node.content, e);
  }
  ...
  syncToMarks(e, t, r) {
    ...
    for (; i < o && (i == s - 1 ? this.top : this.stack[i + 1 << 1]).matchesMark(e[i]) && e[i].type.spec.spanning !== !1; )
      i++;
    for (; i < s; )
      this.destroyRest(), this.top.dirty = Oe, this.index = this.stack.pop(), this.top = this.stack.pop(), s--;
    for (; s < e.length; ) {
  ...
  updateNodeAt(e, t, r, i, s) {
    ...
    return o.dirty == Je && o.dom == o.contentDOM && (o.dirty = Dt), o.update(e, t, r, s) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1;
  }
  ...
  updateNextNode(e, t, r, i, s, o) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof yt) {
        ...
        if (c != null && c != s)
          return !1;
        let u = a.dom, d, f = this.isLocked(u) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != Je && Gi(t, a.outerDeco));
        if (!f && a.update(e, t, r, i))
          return this.destroyBetween(this.index, l), a.dom != u && (this.changed = !0), this.index++, !0;
        if (!f && (d = this.recreateWrapper(a, e, t, r, i, o)))
          return this.top.children[this.index] = d, d.contentDOM && (d.dirty = Dt, d.updateChildren(i, o + 1), d.dirty = Oe), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
  ...
  recreateWrapper(e, t, r, i, s, o) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content))
      return null;
    let l = yt.create(this.top, t, r, i, s, o);
    if (l.contentDOM) {
  ...
  addNode(e, t, r, i, s) {
    let o = yt.create(this.top, e, t, r, i, s);
  ...
  addTextblockHacks() {
    ...
    (!e || // Empty textblock
    !(e instanceof Xr) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((ue || ce) && e && e.dom.contentEditable == "false" && this.addHackNode("IMG", t), this.addHackNode("BR", this.top));
  }
  addHackNode(e, t) {
...
function bs(n, e = null) {
  ...
  if (Yr(t)) {
    for (a = l; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && A.isSelectable(u) && i.parent && !(u.isInline && ed(t.focusNode, t.focusOffset, i.dom))) {
      let d = i.posBefore;
...
function pa(n) {
  return n.editable ? n.hasFocus() : ga(n) && document.activeElement && document.activeElement.contains(n.dom);
}
function st(n, e = !1) {
  ...
  if (ma(n, t), !!pa(n)) {
    if (!e && n.input.mouseDown && n.input.mouseDown.allowDefault && ce) {
      ...
      if (r.anchorNode && i.anchorNode && jt(r.anchorNode, r.anchorOffset, i.anchorNode, i.anchorOffset)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      vo && !(t instanceof I) && (t.$from.parent.inlineContent || (s = bo(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (o = bo(n, t.to))), n.docView.setSelection(r, i, n.root, e), vo && (s && ko(s), o && ko(o)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Nd(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const vo = ue || ce && rd < 63;
function bo(n, e) {
...
function wi(n) {
  return n.contentEditable = "true", ue && n.draggable && (n.draggable = !1, n.wasDraggable = !0), n;
}
function ko(n) {
...
function Nd(n) {
  ...
  e.addEventListener("selectionchange", n.input.hideSelectionGuard = () => {
    (t.anchorNode != r || t.anchorOffset != i) && (e.removeEventListener("selectionchange", n.input.hideSelectionGuard), setTimeout(() => {
      (!pa(n) || n.state.selection.visible) && n.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function Dd(n) {
  let e = n.domSelection(), t = document.createRange(), r = n.cursorWrapper.dom, i = r.nodeName == "IMG";
  i ? t.setEnd(r.parentNode, ee(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && he && gt <= 11 && (r.disabled = !0, r.disabled = !1);
}
function ma(n, e) {
  if (e instanceof A) {
    let t = n.docView.descAt(e.from);
    t != n.lastSelectedViewDesc && (xo(n), t && t.selectNode(), n.lastSelectedViewDesc = t);
  } else
    xo(n);
}
function xo(n) {
...
function wo(n) {
  return n.editable && !n.hasFocus() ? !1 : ga(n);
}
function ga(n) {
  ...
  if (r instanceof I)
    if (t.indexOf("s") > -1) {
      ...
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return s.isAtom || (o = n.docView.descAt(l)) && !o.contentDOM ? A.isSelectable(s) ? ut(n, new A(e < 0 ? n.state.doc.resolve(i.pos - s.nodeSize) : i)) : Qn ? ut(n, new I(n.state.doc.resolve(e < 0 ? l : l + s.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
    if (r instanceof A && r.node.isInline)
      return ut(n, new I(e > 0 ? r.$to : r.$from));
    {
      let i = Xi(n.state, e);
      return i ? ut(n, i) : !1;
    }
...
function Rd(n) {
  ...
  if (!t)
    return;
  let i, s, o = !1;
  for (Pe && t.nodeType == 1 && r < Pr(t) && Bn(t.childNodes[r], -1) && (o = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function Zi(n, e, t) {
  if (e.nodeType != 3) {
    let s, o;
    (o = Ld(e, t)) ? (e = o, t = 0) : (s = Bd(e, t)) && (e = s, t = s.nodeValue.length);
  }
...
function Mo(n, e) {
  ...
  if (!(ce || id) && t.parent.inlineContent) {
...
function Co(n, e, t) {
  ...
  if (!i.parent.inlineContent) {
    let o = e < 0 ? i : s, l = r instanceof Re ? P.near(o, e) : P.findFrom(o, e);
    return l ? ut(n, l) : !1;
  }
  return !1;
}
...
function zd(n) {
  if (!ue || n.state.selection.$head.parentOffset > 0)
    return !1;
  let { focusNode: e, focusOffset: t } = n.domSelectionRange();
  if (e && e.nodeType == 1 && t == 0 && e.firstChild && e.firstChild.contentEditable == "false") {
    let r = e.firstChild;
    To(n, r, "true"), setTimeout(() => To(n, r, "false"), 20);
  }
  return !1;
}
function Vd(n) {
...
function va(n, e) {
  ...
  let o = n.someProp("clipboardSerializer") || _e.fromSchema(n.state.schema), l = Ma(), a = l.createElement("div");
...
`))), 0, 0) : S.empty;
    ...
    if (d)
      ...
      let f = i.marks(), { schema: h } = n.state, p = _e.fromSchema(h);
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || un.fromSchema(n.state.schema)).parseSlice(o, {
    ...
    l = Wd(Eo(l, +u[1], +u[2]), u[4]);
  else if (l = S.maxOpen($d(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, f = 0;
...
function $d(n, e) {
  ...
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return o = null;
      if (c = o.length && s.length && xa(a, s, l, o[o.length - 1], 0))
        o[o.length - 1] = c;
      else {
        o.length && (o[o.length - 1] = wa(o[o.length - 1], s.length));
        let u = ka(l, a);
...
function xa(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let s = xa(n, e, t, r.lastChild, i + 1);
    if (s)
      return r.copy(r.content.replaceChild(r.childCount - 1, s));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(x.from(ka(t, n, i + 1))));
  }
}
function wa(n, e) {
  if (e == 0)
...
let Ao = null;
function Ma() {
  return Ao || (Ao = document.implementation.createHTMLDocument("title"));
}
function jd(n) {
  let e = /^(\s*<meta [^>]*>)*/.exec(n);
  e && (n = n.slice(e[0].length));
  let t = Ma().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Sa[r[1].toLowerCase()]) && (n = i.map((s) => "<" + s + ">").join("") + n + i.map((s) => "</" + s + ">").reverse().join("")), t.innerHTML = n, i)
    for (let s = 0; s < i.length; s++)
...
const de = {}, fe = {}, qd = { touchstart: !0, touchmove: !0 };
class Kd {
  constructor() {
...
function Jd(n) {
  for (let e in de) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Gd(n, r) && !xs(n, r) && (n.editable || !(r.type in fe)) && t(n, r);
    }, qd[e] ? { passive: !0 } : void 0);
  }
  ue && n.dom.addEventListener("input", () => null), es(n);
}
function mt(n, e) {
...
function Yd(n, e) {
  !xs(n, e) && de[e.type] && (n.editable || !(e.type in fe)) && de[e.type](n, e);
}
fe.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Oa(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(De && ce && t.keyCode == 13)))
    ...
    } else n.someProp("handleKeyDown", (r) => r(n, t)) || Fd(n, t) ? t.preventDefault() : mt(n, "key");
};
fe.keyup = (n, e) => {
...
fe.keypress = (n, e) => {
  let t = e;
  if (Oa(n, t) || !t.charCode || t.ctrlKey && !t.altKey || Se && t.metaKey)
    return;
...
function Zd(n, e) {
  ...
  return r && r.isAtom && A.isSelectable(r) ? (an(n, new A(t)), !0) : !1;
}
function Qd(n, e) {
  if (e == -1)
    return !1;
  ...
  return i != null ? (an(n, A.create(n.state.doc, i)), !0) : !1;
}
function ef(n, e, t, r, i) {
  return ws(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (s) => s(n, e, r)) || (i ? Qd(n, t) : Zd(n, t));
}
function tf(n, e, t, r) {
  return ws(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function nf(n, e, t, r) {
  return ws(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || rf(n, t, r);
}
function rf(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (an(n, I.create(r, 0, r.content.size)), !0) : !1;
  let i = r.resolve(e);
  for (let s = i.depth + 1; s > 0; s--) {
    let o = s > i.depth ? i.nodeAfter : i.node(s), l = i.before(s);
    if (o.inlineContent)
      an(n, I.create(r, l + 1, l + 1 + o.content.size));
...
const Ca = Se ? "metaKey" : "ctrlKey";
de.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = Ss(n), i = Date.now(), s = "singleClick";
  i - n.input.lastClick.time < 500 && Xd(t, n.input.lastClick) && !t[Ca] && (n.input.lastClick.type == "singleClick" ? s = "doubleClick" : n.input.lastClick.type == "doubleClick" && (s = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: s };
  let o = n.posAtCoords(Zr(t));
  o && (s == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new sf(n, o, t, !!r)) : (s == "doubleClick" ? tf : nf)(n, o.pos, o.inside, t) ? t.preventDefault() : mt(n, "pointer"));
};
class sf {
  constructor(e, t, r, i) {
    this.view = e, this.pos = t, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!r[Ca], this.allowDefault = r.shiftKey;
    let s, o;
    if (t.inside > -1)
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Zr(e))), this.updateAllowDefault(e), this.allowDefault || !t ? mt(this.view, "pointer") : ef(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    ce && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (an(this.view, P.near(this.view.state.doc.resolve(t.pos))), e.preventDefault()) : mt(this.view, "pointer");
  }
  move(e) {
...
de.touchstart = (n) => {
  n.input.lastTouch = Date.now(), Ss(n), mt(n, "pointer");
};
de.touchmove = (n) => {
  n.input.lastTouch = Date.now(), mt(n, "pointer");
};
de.contextmenu = (n) => Ss(n);
function Oa(n, e) {
...
fe.compositionstart = fe.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    else if (Lr(n), Pe && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
fe.compositionend = (n, e) => {
  n.composing && (n.input.composing = !1, n.input.compositionEndedAt = e.timeStamp, n.input.compositionPendingChanges = n.domObserver.pendingRecords().length ? n.input.compositionID : 0, n.input.compositionNode = null, n.input.compositionPendingChanges && Promise.resolve().then(() => n.domObserver.flush()), n.input.compositionID++, Ta(n, 20));
};
function Ta(n, e) {
...
function lf(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = Zu(e.focusNode, e.focusOffset), r = Qu(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
...
const _n = he && gt < 15 || hn && sd < 604;
de.copy = fe.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let s = _n ? null : t.clipboardData, o = r.content(), { dom: l, text: a } = va(n, o);
...
function Wn(n, e, t, r, i) {
  let s = ba(n, e, t, r, n.state.selection.$from);
...
fe.paste = (n, e) => {
  ...
  if (n.composing && !De)
    return;
  let r = _n ? null : t.clipboardData, i = n.input.shiftKey && n.input.lastKeyCode != 45;
  r && Wn(n, Aa(r), r.getData("text/html"), i, t) ? t.preventDefault() : df(n, t);
};
class Na {
  constructor(e, t, r) {
...
de.dragstart = (n, e) => {
  ...
  t.dataTransfer.clearData(), t.dataTransfer.setData(_n ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", _n || t.dataTransfer.setData("text/plain", c), n.dragging = new Na(u, !t[Da], o);
};
de.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
fe.drop = (n, e) => {
  ...
  o ? n.someProp("transformPasted", (p) => {
    o = p(o, n);
  }) : o = ba(n, Aa(t.dataTransfer), _n ? null : t.dataTransfer.getData("text/html"), !1, s);
  let l = !!(r && !t[Da]);
  ...
  if (!o)
    return;
  t.preventDefault();
  let a = o ? Gl(n.state.doc, s.pos, o) : s.pos;
  a == null && (a = s.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
  ...
  if (d && A.isSelectable(o.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(o.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((m, y, v, w) => p = w), c.setSelection(ks(n, h, c.doc.resolve(p)));
  }
...
de.beforeinput = (n, e) => {
  if (ce && De && e.inputType == "deleteContentBackward") {
...
class Br {
  ...
  eq(e) {
    return this == e || e instanceof Br && (this.spec.key && this.spec.key == e.spec.key || this.toDOM == e.toDOM && qn(this.spec, e.spec));
  }
  destroy(e) {
...
class Ms {
  ...
  eq(e) {
    return this == e || e instanceof Ms && qn(this.attrs, e.attrs) && qn(this.spec, e.spec);
  }
  destroy() {
  }
}
...
class J {
  ...
  */
  static create(e, t) {
    return t.length ? zr(t, e, 0, zt) : ie;
  }
  /**
  ...
  */
  mapInner(e, t, r, i, s) {
    ...
    return this.children.length ? ff(this.children, o || [], e, t, r, i, s) : o ? new J(o.sort(Vt), en) : ie;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (u = Ra(t, l, c)) {
        for (i || (i = this.children.slice()); s < i.length && i[s] < a; )
          s += 3;
        i[s] == a ? i[s + 2] = i[s + 2].addInner(l, u, c + 1) : i.splice(s, 0, a, a + l.nodeSize, zr(u, l, c + 1, zt)), s += 3;
      }
    });
    let o = Ia(s ? Pa(t) : t, -r);
    for (let l = 0; l < o.length; l++)
      o[l].type.valid(e, o[l]) || o.splice(l--, 1);
    return new J(o.length ? this.local.concat(o).sort(Vt) : this.local, i || this.children);
  }
  /**
...
class ft {
  ...
  forChild(e, t) {
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      s != ie && (s instanceof ft ? r = r.concat(s.members) : r.push(s));
    }
    return ft.from(r);
  }
  eq(e) {
    ...
    t.maps[c].forEach((f, h, p, m) => {
      ...
      for (let v = 0; v < l.length; v += 3) {
        ...
        if (w < 0 || f > w + u - d)
          continue;
        let C = l[v] + u - d;
        h >= C ? l[v + 1] = f <= C ? -2 : -1 : f >= u && y && (l[v] += y, l[v + 1] += y);
      }
      d += y;
    }), u = t.maps[c].map(u, -1);
  }
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      if (y && m == d && m + y.nodeSize == h) {
        ...
        v != ie ? (l[c] = d, l[c + 1] = h, l[c + 2] = v) : (l[c + 1] = -2, a = !0);
      } else
        a = !0;
    }
  if (a) {
    let c = hf(l, n, e, t, i, s, o), u = zr(c, r, 0, o);
    e = u.local;
  ...
  for (let t = 0; t < e.length - 1; t++) {
    ...
    if (r.from != r.to)
      for (let i = t + 1; i < e.length; i++) {
        let s = e[i];
        if (s.from == r.from) {
          s.to != r.to && (e == n && (e = n.slice()), e[i] = s.copy(s.from, r.to), No(e, i + 1, s.copy(r.to, s.to)));
          continue;
        } else {
          s.from < r.to && (e == n && (e = n.slice()), e[t] = r.copy(r.from, s.from), No(e, i, r.copy(s.from, r.to)));
          break;
        }
      }
  }
...
class yf {
  ...
  flush() {
    ...
    t.length && (this.queue = []);
    let r = e.domSelectionRange(), i = !this.suppressingSelectionUpdates && !this.currentSelection.eq(r) && wo(e) && !this.ignoreSelectionChange(r), s = -1, o = -1, l = !1, a = [];
    if (e.editable)
    ...
    let c = null;
    s < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Yr(r) && (c = bs(e)) && c.eq(P.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, st(e), this.currentSelection.set(r), e.scrollToSelection()) : (s > -1 || i) && (s > -1 && (e.docView.markDirty(s, o), vf(e)), this.handleDOMChange(s, o, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || st(e), this.currentSelection.set(r));
  }
...
let Do = /* @__PURE__ */ new WeakMap(), Io = !1;
function vf(n) {
  if (!Do.has(n) && (Do.set(n, null), ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(n.dom).whiteSpace) !== -1)) {
    if (n.requiresGeckoHackNode = Pe, Io)
      return;
    console.warn("ProseMirror expects the CSS white-space property to be set, preferably to 'pre-wrap'. It is recommended to load style/prosemirror.css from the prosemirror-view package."), Io = !0;
  }
}
function Ro(n, e) {
  let t = e.startContainer, r = e.startOffset, i = e.endContainer, s = e.endOffset, o = n.domAtPos(n.state.selection.anchor);
  return jt(o.node, o.offset, i, s) && ([t, r, i, s] = [i, s, t, r]), { anchorNode: t, anchorOffset: r, focusNode: i, focusOffset: s };
}
function bf(n, e) {
...
function xf(n, e, t) {
  ...
  if (u && n.dom.contains(u.nodeType == 1 ? u : u.parentNode) && (c = [{ node: u, offset: a.anchorOffset }], Yr(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), ce && n.input.lastKeyCode === 8)
    for (let y = s; y > i; y--) {
  ...
  let d = n.state.doc, f = n.someProp("domParser") || un.fromSchema(n.state.schema), h = d.resolve(o), p = null, m = f.parse(r, {
    topNode: h.parent,
...
function wf(n) {
  ...
  if (n.nodeName == "BR" && n.parentNode) {
    if (ue && /^(ul|ol)$/i.test(n.parentNode.nodeName)) {
      let t = document.createElement("div");
      return t.appendChild(document.createElement("li")), { skip: t };
    } else if (n.parentNode.lastChild == n || ue && /^(tr|table)$/i.test(n.parentNode.nodeName))
      return { ignore: !0 };
  } else if (n.nodeName == "IMG" && n.getAttribute("mark-placeholder"))
    return { ignore: !0 };
  return null;
}
const Sf = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function Mf(n, e, t, r, i) {
  let s = n.input.compositionPendingChanges || (n.composing ? n.input.compositionID : 0);
  if (n.input.compositionPendingChanges = 0, e < 0) {
    let E = n.input.lastSelectionTime > Date.now() - 50 ? n.input.lastSelectionOrigin : null, B = bs(n, E);
    if (B && !n.state.selection.eq(B)) {
      if (ce && De && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (j) => j(n, At(13, "Enter"))))
        return;
  ...
  let a = n.state.selection, c = xf(n, e, t), u = n.state.doc, d = u.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = Tf(d.content, c.doc.content, c.from, f, h);
  if ((hn && n.input.lastIOSEnter > Date.now() - 225 || De) && i.some((E) => E.nodeType == 1 && !Sf.test(E.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (E) => E(n, At(13, "Enter")))) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && p.start == p.endB && n.state.selection instanceof I && (p.start > n.state.selection.from && p.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? p.start = n.state.selection.from : p.endA < n.state.selection.to && p.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (p.endB += n.state.selection.to - p.endA, p.endA = n.state.selection.to)), he && gt <= 11 && p.endB == p.start + 1 && p.endA == p.start && p.start > c.from && c.doc.textBetween(p.start - c.from - 1, p.start - c.from + 1) == "  " && (p.start--, p.endA--, p.endB--);
  let m = c.doc.resolveNoCache(p.start - c.from), y = c.doc.resolveNoCache(p.endB - c.from), v = u.resolve(p.start), w = m.sameParent(y) && m.parent.inlineContent && v.end() >= p.endA, C;
  if ((hn && n.input.lastIOSEnter > Date.now() - 225 && (!w || i.some((E) => E.nodeName == "DIV" || E.nodeName == "P")) || !w && m.pos < c.doc.content.size && !m.sameParent(y) && (C = P.findFrom(c.doc.resolve(m.pos + 1), 1, !0)) && C.head == y.pos) && n.someProp("handleKeyDown", (E) => E(n, At(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (n.state.selection.anchor > p.start && Of(u, p.start, p.endA, m, y) && n.someProp("handleKeyDown", (E) => E(n, At(8, "Backspace")))) {
    De && ce && n.domObserver.suppressSelectionUpdates();
    return;
  }
  ce && De && p.endB == p.start && (n.input.lastAndroidDelete = Date.now()), De && !w && m.start() != y.start() && y.parentOffset == 0 && m.depth == y.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, y = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
    n.someProp("handleKeyDown", function(E) {
      return E(n, At(13, "Enter"));
    });
  }, 20));
  let g = p.start, T = p.endA, k, D, z;
  if (w) {
    if (m.pos == y.pos)
      he && gt <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => st(n), 20)), k = n.state.tr.delete(g, T), D = u.resolve(p.start).marksAcross(u.resolve(p.endA));
    else if (
      // Adding or removing a mark
      p.endA == p.endB && (z = Cf(m.parent.content.cut(m.parentOffset, y.parentOffset), v.parent.content.cut(v.parentOffset, p.endA - v.start())))
    )
      k = n.state.tr, z.type == "add" ? k.addMark(g, T, z.mark) : k.removeMark(g, T, z.mark);
      ...
      if (n.someProp("handleTextInput", (B) => B(n, g, T, E)))
        return;
      k = n.state.tr.insertText(E, g, T);
    }
  }
  if (k || (k = n.state.tr.replace(g, T, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    let E = Po(n, k.doc, c.sel);
    E && !(ce && De && n.composing && E.empty && (p.start != p.endB || n.input.lastAndroidDelete < Date.now() - 100) && (E.head == g || E.head == k.mapping.map(T) - 1) || he && E.empty && E.head == g) && k.setSelection(E);
  }
...
function Of(n, e, t, r, i) {
  ...
  if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
    return !1;
  let o = n.resolve(Mi(s, !0, !0));
  return !o.parent.isTextblock || o.pos > t || Mi(o, !0, !1) < t ? !1 : r.parent.content.cut(r.parentOffset).eq(o.parent.content);
}
function Mi(n, e, t) {
...
function Tf(n, e, t, r, i) {
  ...
  if (o < s && n.size < e.size) {
    let a = r <= s && r >= o ? s - r : 0;
    s -= a, s && s < e.size && Lo(e.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1), l = s + (l - o), o = s;
  } else if (l < s) {
    let a = r <= s && r >= l ? s - r : 0;
    s -= a, s && s < n.size && Lo(n.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1), o = s + (o - l), l = s;
  }
...
class Ef {
  ...
  */
  constructor(e, t) {
    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new Kd(), this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(Ho), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : typeof e == "function" ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = Vo(this), zo(this), this.nodeViews = Fo(this), this.docView = go(this.state.doc, Bo(this), Si(this), this.dom, this), this.domObserver = new yf(this, (r, i, s, o) => Mf(this, r, i, s, o)), this.domObserver.start(), Jd(this), this.updatePluginViews();
  }
  /**
  Holds `true` when a
  ...
  */
  update(e) {
    e.handleDOMEvents != this._props.handleDOMEvents && es(this);
    let t = this._props;
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    e.storedMarks && this.composing && (Ea(this), o = !0), this.state = e;
    let l = i.plugins != e.plugins || this._props.plugins != t.plugins;
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let h = Fo(this);
      Nf(h, this.nodeViews) && (this.nodeViews = h, s = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && es(this), this.editable = Vo(this), zo(this);
    let a = Si(this), c = Bo(this), u = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", d = s || !this.docView.matchesNode(e.doc, c, a);
    (d || !e.selection.eq(i.selection)) && (o = !0);
    let f = u == "preserve" && o && this.dom.style.overflowAnchor == null && ad(this);
    if (o) {
      this.domObserver.stop();
      let h = d && (he || ce) && !this.composing && !i.selection.empty && !e.selection.empty && Af(i.selection, e.selection);
      if (d) {
        let p = ce ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = lf(this)), (s || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = go(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Id(this)) ? st(this, h) : (ma(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
  ...
  */
  scrollToSelection() {
    ...
    if (!this.someProp("handleScrollToSelection", (t) => t(this))) if (this.state.selection instanceof A) {
      ...
      t.nodeType == 1 && co(this, t.getBoundingClientRect(), e);
    } else
      co(this, this.coordsAtPos(this.state.selection.head, 1), e);
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Na(e.slice, e.move, i < 0 ? void 0 : A.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && ud(this.dom), st(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Ud(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Si(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Yu());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return ue && this.root.nodeType === 11 && td(this.dom.ownerDocument) == this.dom && bf(this, e) || e;
  }
  /**
  @internal
  */
...
for (var te = 0; te < 10; te++) bt[48 + te] = bt[96 + te] = String(te);
for (var te = 1; te <= 24; te++) bt[te + 111] = "F" + te;
for (var te = 65; te <= 90; te++)
  bt[te] = String.fromCharCode(te + 32), Vr[te] = String.fromCharCode(te);
for (var Ci in bt) Vr.hasOwnProperty(Ci) || (Vr[Ci] = bt[Ci]);
function Rf(n) {
  var e = Df && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || If && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Vr : bt)[n.keyCode] || n.key || "Unidentified";
...
function zf(n) {
  return new ge({ props: { handleKeyDown: La(n) } });
}
function La(n) {
  let e = Bf(n);
  return function(t, r) {
    let i = Rf(r), s, o = e[Oi(i, r)];
    ...
    if (i.length == 1 && i != " ") {
      ...
      if ((r.shiftKey || r.altKey || r.metaKey || i.charCodeAt(0) > 127) && (s = bt[r.keyCode]) && s != i) {
        let l = e[Oi(s, r)];
        if (l && l(t.state, t.dispatch, t))
          return !0;
      }
...
const Ff = (n, e, t) => {
  ...
  let s = i.nodeBefore;
  if (!s.type.spec.isolating && Ha(n, i, e))
    return !0;
  if (r.parent.content.size == 0 && (pn(s, "end") || A.isSelectable(s))) {
    let o = Ur(n.doc, r.before(), r.after(), S.empty);
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = n.tr.step(o);
        l.setSelection(pn(s, "end") ? P.findFrom(l.doc.resolve(l.mapping.map(i.pos, -1)), -1) : A.create(l.doc, i.pos - s.nodeSize)), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const _f = (n, e, t) => {
  ...
  if (Ha(n, i, e))
    return !0;
  if (r.parent.content.size == 0 && (pn(s, "start") || A.isSelectable(s))) {
    let o = Ur(n.doc, r.before(), r.after(), S.empty);
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = n.tr.step(o);
        l.setSelection(pn(s, "start") ? P.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : A.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
function Ha(n, e, t) {
  ...
  let a = P.findFrom(e, 1), c = a && a.$from.blockRange(a.$to), u = c && xn(c);
  if (u != null && u >= e.depth)
    return t && t(n.tr.lift(c, u).scrollIntoView()), !0;
  if (l && pn(i, "start", !0) && pn(r, "end")) {
    let d = r, f = [];
...
function rh(n, e = null) {
  return function(t, r) {
    ...
    if (o.depth >= 2 && i.node(o.depth - 1).type.compatibleContent(n) && o.startIndex == 0) {
      ...
      a = new Nr(u, u, o.depth), o.endIndex < o.parent.childCount && (o = new Nr(i, t.doc.resolve(s.end(o.depth)), o.depth)), l = !0;
    }
    let c = gs(a, n, e, o);
    return c ? (r && r(ih(t.tr, o, c, l, n).scrollIntoView()), !0) : !1;
  };
}
function ih(n, e, t, r, i) {
  ...
  for (let u = e.startIndex, d = e.endIndex, f = !0; u < d; u++, f = !1)
    !f && on(n.doc, a, l) && (n.split(a, l), a += 2 * l), a += c.child(u).nodeSize;
  return n;
}
function sh(n) {
  return function(e, t) {
    let { $from: r, $to: i } = e.selection, s = r.blockRange(i, (o) => o.childCount > 0 && o.firstChild.type == n);
    return s ? t ? r.node(s.depth - 1).type == n ? oh(e, t, n, s) : lh(e, t, s) : !0 : !1;
  };
}
function oh(n, e, t, r) {
  let i = n.tr, s = r.end, o = r.$to.end(r.depth);
  s < o && (i.step(new G(s - 1, o, s, o, new S(x.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new Nr(i.doc.resolve(r.$from.pos), i.doc.resolve(o), r.depth));
  const l = xn(r);
  if (l == null)
    return !1;
  i.lift(r, l);
  ...
  return n.style ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((s, o) => {
        const l = o.attribute.parseHTML ? o.attribute.parseHTML(t) : dh(t.getAttribute(o.name));
        return l == null ? s : {
          ...s,
          [o.name]: l
        };
...
function _o(n) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(n).filter(([e, t]) => e === "attrs" && uh(t) ? !1 : t != null)
  );
}
function fh(n, e) {
  var t;
  const r = ja(n), { nodeExtensions: i, markExtensions: s } = ti(n), o = (t = i.find((c) => M(c, "topNode"))) === null || t === void 0 ? void 0 : t.name, l = Object.fromEntries(i.map((c) => {
    ...
    p && (h.parseDOM = p.map((v) => jo(v, u)));
    const m = M(c, "renderHTML", d);
    m && (h.toDOM = (v) => m({
      node: v,
      HTMLAttributes: ts(v, u)
    }));
    ...
    p && (h.parseDOM = p.map((y) => jo(y, u)));
    const m = M(c, "renderHTML", d);
    return m && (h.toDOM = (y) => m({
      mark: y,
      HTMLAttributes: ts(y, u)
    })), [c.name, h];
  }));
  return new pu({
    topNode: o,
...
function vr(n) {
  ...
  return o.forEach((f) => {
    ...
    const p = a.state.tr, m = Qr({
      ...
      to: i
    }, { commands: v, chain: w, can: C } = new ei({
      editor: t,
      state: m
    });
    f.handler({
...
function xh(n) {
  ...
  return t.map((u) => new ge({
    ...
    appendTransaction: (d, f, h) => {
      const p = d[0], m = p.getMeta("uiEvent") === "paste" && !i, y = p.getMeta("uiEvent") === "drop" && !s, v = p.getMeta("applyPasteRules"), w = !!v;
      if (!m && !y && !w)
        return;
      if (w) {
        const { from: T, text: k } = v, D = T + k.length, z = kh(k);
        return a({
          rule: u,
          state: h,
          from: T,
...
class rn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = rn.resolve(e), this.schema = fh(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = rn.sort(rn.flatten(e)), r = wh(t.map((i) => i.name));
  ...
  get plugins() {
    const { editor: e } = this, t = rn.sort([...this.extensions].reverse()), r = [], i = [], s = t.map((o) => {
      ...
      let u = {};
      if (o.type === "mark" && o.config.exitable && (u.ArrowRight = () => Le.handleExit({ editor: e, mark: o })), c) {
      ...
      Wo(o, e.options.enableInputRules) && f && r.push(...f());
      const h = M(o, "addPasteRules", l);
      Wo(o, e.options.enablePasteRules) && h && i.push(...h());
...
function Ei(n) {
  return Sh(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function ri(n, e) {
  const t = { ...n };
  return Ei(n) && Ei(e) && Object.keys(e).forEach((r) => {
    Ei(e[r]) ? r in n ? t[r] = ri(n[r], e[r]) : Object.assign(t, { [r]: e[r] }) : Object.assign(t, { [r]: e[r] });
  }), t;
}
class se {
  constructor(e = {}) {
      ...
      new ge({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: n } = this, { state: e, schema: t } = n, { doc: r, selection: i } = e, { ranges: s } = i, o = Math.min(...s.map((u) => u.$from.pos)), l = Math.max(...s.map((u) => u.$to.pos)), a = qa(t);
            return Wa(r, { from: o, to: l }, {
...
}), Ch = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
  n.isDestroyed || (e.dom.blur(), (t = window == null ? void 0 : window.getSelection()) === null || t === void 0 || t.removeAllRanges());
}), !0), Oh = (n = !1) => ({ commands: e }) => e.setContent("", n), Th = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, Eh = (n) => (e) => n(e), Ah = () => ({ state: n, dispatch: e }) => Yf(n, e), Nh = (n, e) => ({ editor: t, tr: r }) => {
...
}, Ph = () => ({ state: n, dispatch: e }) => Vf(n, e), Lh = () => ({ commands: n }) => n.keyboardShortcut("Enter"), Bh = () => ({ state: n, dispatch: e }) => Gf(n, e);
function Fr(n, e, t = { strict: !0 }) {
  const r = Object.keys(e);
  return r.length ? r.every((i) => t.strict ? e[i] === n[i] : Es(e[i]) ? e[i].test(n[i]) : e[i] === n[i]) : !0;
}
function ns(n, e, t = {}) {
...
function As(n, e, t = {}) {
  ...
  for (ns([...r.node.marks], e, t); s > 0 && i.isInSet(n.parent.child(s - 1).marks); )
    s -= 1, o -= n.parent.child(s).nodeSize;
  for (; l < n.parent.childCount && zh([...n.parent.child(l).marks], e, t); )
...
const Vh = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
...
function Ka(n, e = null) {
  ...
  return e === "all" ? I.create(n, it(0, i, s), it(n.content.size, i, s)) : I.create(n, it(e, i, s), it(e, i, s));
}
function Ds() {
  return [
    "iPad Simulator",
...
const Hh = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: s }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  ...
  if (s && n === null && !Ns(t.state.selection))
    return o(), !0;
  const l = Ka(i.doc, n) || t.state.selection, a = t.state.selection.eq(l);
  return s && (a || i.setSelection(l), a && i.storedMarks && i.setStoredMarks(i.storedMarks), o()), !0;
}, $h = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), jh = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), Ja = (n) => {
  const e = n.childNodes;
  for (let t = e.length - 1; t >= 0; t -= 1) {
    const r = e[t];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? n.removeChild(r) : r.nodeType === 1 && Ja(r);
  }
  return n;
};
function qo(n) {
...
function Hr(n, e, t) {
  ...
  if (i) {
    const s = un.fromSchema(e);
    return t.slice ? s.parseSlice(qo(n), t.parseOptions).content : s.parse(qo(n), t.parseOptions);
  }
  return Hr("", e, t);
}
function _h(n, e, t) {
...
const Wh = (n) => n.toString().startsWith("<"), qh = (n, e, t) => ({ tr: r, dispatch: i, editor: s }) => {
  if (i) {
    t = {
      parseOptions: {},
      updateSelection: !0,
    ...
    let f;
    c ? (Array.isArray(e) ? f = e.map((h) => h.text || "").join("") : typeof e == "object" && e && e.text ? f = e.text : f = e, r.insertText(f, l, a)) : (f = o, r.replaceWith(l, a, f)), t.updateSelection && _h(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: l, text: f }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: f });
  }
  return !0;
}, Kh = () => ({ state: n, dispatch: e }) => qf(n, e), Jh = () => ({ state: n, dispatch: e }) => Kf(n, e), Uh = () => ({ state: n, dispatch: e }) => Ff(n, e), Gh = () => ({ state: n, dispatch: e }) => _f(n, e), Yh = () => ({ tr: n, state: e, dispatch: t }) => {
  try {
...
}, Zh = () => ({ state: n, dispatch: e }) => Hf(n, e), Qh = () => ({ state: n, dispatch: e }) => $f(n, e);
function Ua() {
...
const tp = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const s = ep(n).split(/-(?!$)/), o = s.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: o === "Space" ? " " : o,
...
const np = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = X(n, t.schema);
  return Kn(t, i, e) ? Jf(t, r) : !1;
}, rp = () => ({ state: n, dispatch: e }) => Xf(n, e), ip = (n) => ({ state: e, dispatch: t }) => {
  const r = X(n, e.schema);
  return sh(r)(e, t);
}, sp = () => ({ state: n, dispatch: e }) => Uf(n, e);
function ii(n, e) {
...
const op = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return l ? (l === "node" && (s = X(n, r.schema)), l === "mark" && (o = wt(n, r.schema)), i && t.selection.ranges.forEach((a) => {
    r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, u) => {
      s && s === c.type && t.setNodeMarkup(u, void 0, Ko(c.attrs, e)), o && c.marks.length && c.marks.forEach((d) => {
        o === d.type && t.addMark(u, u + c.nodeSize, o.create(Ko(d.attrs, e)));
      });
    });
  }), !0) : !1;
}, lp = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), ap = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), cp = () => ({ state: n, dispatch: e }) => jf(n, e), up = () => ({ state: n, dispatch: e }) => Wf(n, e), dp = () => ({ state: n, dispatch: e }) => Zf(n, e), fp = () => ({ state: n, dispatch: e }) => th(n, e), hp = () => ({ state: n, dispatch: e }) => eh(n, e);
function Ga(n, e, t = {}) {
  return Hr(n, e, { slice: !1, parseOptions: t });
}
const pp = (n, e = !1, t = {}) => ({ tr: r, editor: i, dispatch: s }) => {
  const { doc: o } = r, l = Ga(n, i.schema, t);
...
function kp(n, e) {
  ...
  return t === "node" ? bp(n, e) : t === "mark" ? tr(n, e) : {};
}
function Ya(n, e, t) {
  const r = [];
  return n === e ? t.resolve(n).marks().forEach((i) => {
    const s = t.resolve(n - 1), o = As(s, i.type);
    o && r.push({
      mark: i,
      ...o
    });
  ...
  if (i.forEach(({ $from: d, $to: f }) => {
    ...
    n.doc.nodesBetween(h, p, (m, y) => {
      if (!m.isText && !m.marks.length)
        return;
      const v = Math.max(h, y), w = Math.min(p, y + m.nodeSize), C = w - v;
...
function xp(n, e, t = {}) {
  if (!e)
    return Kn(n, null, t) || rs(n, null, t);
  const r = ii(e, n.schema);
  return r === "node" ? Kn(n, e, t) : r === "mark" ? rs(n, e, t) : !1;
}
function Jo(n, e) {
...
function Xa(n, e, t) {
  const i = n.state.doc.content.size, s = it(e, 0, i), o = it(t, 0, i), l = n.coordsAtPos(s), a = n.coordsAtPos(o, -1), c = Math.min(l.top, a.top), u = Math.max(l.bottom, a.bottom), d = Math.min(l.left, a.left), f = Math.max(l.right, a.right), h = f - d, p = u - c, v = {
    top: c,
    bottom: u,
    left: d,
    right: f,
...
const Cp = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return Mp(r, t, a);
}, Op = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), Tp = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
  const s = X(n, t.schema);
  return s.isTextblock ? i().command(({ commands: o }) => $o(s, e)(t) ? !0 : o.clearNodes()).command(({ state: o }) => $o(s, e)(o, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1);
  ...
  if (t) {
    const { doc: r } = e, { from: i, to: s } = typeof n == "number" ? { from: n, to: n } : n, o = I.atStart(r).from, l = I.atEnd(r).to, a = it(i, o, l), c = it(s, o, l), u = I.create(r, a, c);
    e.setSelection(u);
  }
  return !0;
...
const Dp = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (s instanceof A && s.node.isBlock)
    return !l.parentOffset || !on(o, l.pos) ? !1 : (r && (n && Uo(t, i.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
  if (!l.parent.isBlock)
    return !1;
  if (r) {
    const d = a.parentOffset === a.parent.content.size;
    s instanceof I && e.deleteSelection();
    const f = l.depth === 0 ? void 0 : mp(l.node(-1).contentMatchAt(l.indexAfter(-1)));
    let h = d && f ? [
      {
        type: f,
        attrs: u
      }
    ] : void 0, p = on(e.doc, e.mapping.map(l.pos), 1, h);
    if (!h && !p && on(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) && (p = !0, h = f ? [
      {
        type: f,
        attrs: u
      }
    ...
    n && Uo(t, i.extensionManager.splittableMarks), e.scrollIntoView();
  }
  return !0;
}, Ip = (n) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  var s;
  ...
  if (l.parent.content.size === 0 && l.node(-1).childCount === l.indexAfter(-1)) {
    ...
    if (r) {
      ...
      const w = l.indexAfter(-1) < l.node(-2).childCount ? 1 : l.indexAfter(-2) < l.node(-3).childCount ? 2 : 3, C = Sr(d, l.node().type.name, l.node().attrs), g = ((s = o.contentMatch.defaultType) === null || s === void 0 ? void 0 : s.createAndFill(C)) || void 0;
      y = y.append(x.from(o.createAndFill(null, g) || void 0));
      const T = l.before(l.depth - (v - 1));
      e.replace(T, l.after(-w), new S(y, 4 - v, 0));
      let k = -1;
      e.doc.nodesBetween(T, e.doc.content.size, (D, z) => {
        if (k > -1)
          return !1;
        D.isTextblock && D.content.size === 0 && (k = z + 1);
      }), k > -1 && e.setSelection(I.near(e.doc.resolve(k))), e.scrollIntoView();
    }
    return !0;
  }
  const f = a.pos === l.end() ? u.contentMatchAt(0).defaultType : null, h = Sr(d, u.type.name, u.attrs), p = Sr(d, l.node().type.name, l.node().attrs);
  ...
  if (!on(e.doc, l.pos, 2))
    return !1;
  if (r) {
    const { selection: y, storedMarks: v } = t, { splittableMarks: w } = i.extensionManager, C = v || y.$to.parentOffset && y.$from.marks();
...
}, Rp = (n, e, t, r = {}) => ({ editor: i, tr: s, state: o, dispatch: l, chain: a, commands: c, can: u }) => {
  const { extensions: d, splittableMarks: f } = i.extensionManager, h = X(n, o.schema), p = X(e, o.schema), { selection: m, storedMarks: y } = o, { $from: v, $to: w } = m, C = v.blockRange(w), g = y || m.$to.parentOffset && m.$from.marks();
  if (!C)
    return !1;
  const T = Is((k) => Jo(k.type.name, d))(m);
  if (C.depth >= 1 && T && C.depth - T.depth <= 1) {
    if (T.node.type === h)
      return c.liftListItem(p);
    if (Jo(T.node.type.name, d) && h.validContent(T.node.content) && l)
      return a().command(() => (s.setNodeMarkup(T.pos, h), !0)).command(() => Ai(s, h)).command(() => Ni(s, h)).run();
  }
  return !t || !g || !l ? a().command(() => u().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => Ai(s, h)).command(() => Ni(s, h)).run() : a().command(() => {
    const k = u().wrapInList(h, r), D = g.filter((z) => f.includes(z.type.name));
    return s.ensureMarks(D), k ? !0 : c.clearNodes();
  }).wrapInList(h, r).command(() => Ai(s, h)).command(() => Ni(s, h)).run();
}, Pp = (n, e = {}, t = {}) => ({ state: r, commands: i }) => {
  ...
  return Kn(r, s, t) ? i.setNode(o) : i.setNode(s, t);
}, Bp = (n, e = {}) => ({ state: t, commands: r }) => {
  const i = X(n, t.schema);
  return Kn(t, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, zp = () => ({ state: n, dispatch: e }) => {
  const t = n.plugins;
  for (let r = 0; r < t.length; r += 1) {
    const i = t[r];
    let s;
  ...
  var s;
  const { extendEmptyMarkRange: o = !1 } = e, { selection: l } = t, a = wt(n, r.schema), { $from: c, empty: u, ranges: d } = l;
  if (!i)
    return !0;
  if (u && o) {
    let { from: f, to: h } = l;
    const p = (s = c.marks().find((y) => y.type === a)) === null || s === void 0 ? void 0 : s.attrs, m = As(c, a, p);
...
var _p = /* @__PURE__ */ Object.freeze({
  ...
  scrollIntoView: lp,
  selectAll: ap,
  selectNodeBackward: cp,
  selectNodeForward: up,
  selectParentNode: dp,
  selectTextblockEnd: fp,
  selectTextblockStart: hp,
  setContent: pp,
  setMark: Cp,
  setMeta: Op,
  setNode: Tp,
...
const Wp = se.create({
  ...
  addKeyboardShortcuts() {
    const n = () => this.editor.commands.first(({ commands: o }) => [
      ...
      () => o.command(({ tr: l }) => {
        const { selection: a, doc: c } = l, { empty: u, $anchor: d } = a, { pos: f, parent: h } = d, p = d.parent.isTextblock && f > 0 ? l.doc.resolve(f - 1) : d, m = p.parent.type.spec.isolating, y = d.pos - d.parentOffset, v = m && p.parent.childCount === 1 ? y === d.pos : P.atStart(c).from === f;
...
class Nt {
  ...
  get parent() {
    ...
    return new Nt(t, this.editor);
  }
  get before() {
    let e = this.resolvedPos.doc.resolve(this.from - (this.isBlock ? 1 : 2));
    return e.depth !== this.depth && (e = this.resolvedPos.doc.resolve(this.from - 3)), new Nt(e, this.editor);
  }
  get after() {
    let e = this.resolvedPos.doc.resolve(this.to + (this.isBlock ? 2 : 1));
    return e.depth !== this.depth && (e = this.resolvedPos.doc.resolve(this.to + 3)), new Nt(e, this.editor);
  }
  get children() {
    const e = [];
    return this.node.content.forEach((t, r) => {
      ...
      if (!i && o.depth <= this.depth)
        return;
      const l = new Nt(o, this.editor, i, i ? t : null);
      i && (l.actualDepth = this.depth + 1), e.push(new Nt(o, this.editor, i, i ? t : null));
    }), e;
  }
  get firstChild() {
...
let Xp = class extends ch {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = Yp(Gp, this.options.injectNonce));
  }
  /**
   ...
   */
  registerPlugin(e, t) {
    const r = _a(t) ? t(e, [...this.state.plugins]) : [...this.state.plugins, e], i = this.state.reconfigure({ plugins: r });
  ...
  createExtensionManager() {
    ...
    this.extensionManager = new rn(i, this);
  }
  /**
   ...
   */
  createView() {
    const e = Ga(this.options.content, this.schema, this.options.parseOptions), t = Ka(e, this.options.autofocus);
   ...
   */
  getAttributes(e) {
    return kp(this.state, e);
  }
  isActive(e, t) {
    const r = typeof e == "string" ? e : null, i = typeof e == "string" ? t : e;
    return xp(this.state, r, i);
  }
  /**
   ...
   */
  getHTML() {
    return yp(this.state.doc.content, this.schema);
  }
  /**
  ...
  return new ni({
    ...
    handler: ({ state: e, range: t, match: r }) => {
      ...
      if (o) {
        ...
        if (Ya(t.from, t.to, e.doc).filter((h) => h.mark.type.excluded.find((m) => m === n.type && m !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
...
function Jn(n) {
  return new ni({
    ...
    handler: ({ state: e, range: t, match: r, chain: i }) => {
      const s = R(n.getAttributes, void 0, r) || {}, o = e.tr.delete(t.from, t.to), a = o.doc.resolve(t.from).blockRange(), c = a && gs(a, n.type, s);
      if (!c)
        return null;
  ...
  return new yh({
    ...
    handler: ({ state: e, range: t, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (Ya(t.from, t.to, e.doc).filter((p) => p.mark.type.excluded.find((y) => y === n.type && y !== p.mark.type)).filter((p) => p.to > d).length)
          return null;
...
var pe = "top", Ee = "bottom", Ae = "right", me = "left", Rs = "auto", nr = [pe, Ee, Ae, me], yn = "start", Un = "end", em = "clippingParents", Qa = "viewport", An = "popper", tm = "reference", Yo = /* @__PURE__ */ nr.reduce(function(n, e) {
  return n.concat([e + "-" + yn, e + "-" + Un]);
}, []), ec = /* @__PURE__ */ [].concat(nr, [Rs]).reduce(function(n, e) {
  return n.concat([e, e + "-" + yn, e + "-" + Un]);
}, []), nm = "beforeRead", rm = "read", im = "afterRead", sm = "beforeMain", om = "main", lm = "afterMain", am = "beforeWrite", cm = "write", um = "afterWrite", dm = [nm, rm, im, sm, om, lm, am, cm, um];
function Ue(n) {
...
function fm(n) {
  ...
  Object.keys(e.elements).forEach(function(t) {
    ...
    !Te(s) || !Ue(s) || (Object.assign(s.style, r), Object.keys(i).forEach(function(o) {
      var l = i[o];
...
function hm(n) {
  ...
  return Object.assign(e.elements.popper.style, t.popper), e.styles = t, e.elements.arrow && Object.assign(e.elements.arrow.style, t.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !Te(i) || !Ue(i) || (Object.assign(i.style, l), Object.keys(s).forEach(function(a) {
        i.removeAttribute(a);
      }));
    });
  };
...
var Ft = Math.max, $r = Math.min, vn = Math.round;
function ss() {
...
function bn(n, e, t) {
  ...
  var o = Wt(n) ? xe(n) : window, l = o.visualViewport, a = !nc() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, u = (r.top + (a && l ? l.offsetTop : 0)) / s, d = r.width / i, f = r.height / s;
  return {
    width: d,
    height: f,
    top: u,
...
function si(n) {
  return Ue(n) === "html" ? n : (
    ...
    (Ps(n) ? n.host : null) || // ShadowRoot detected
...
function mm(n) {
  var e = /firefox/i.test(ss()), t = /Trident/i.test(ss());
  if (t && Te(n)) {
    var r = ot(n);
    if (r.position === "fixed")
      return null;
  ...
  var i = si(n);
  for (Ps(i) && (i = i.host); Te(i) && ["html", "body"].indexOf(Ue(i)) < 0; ) {
    var s = ot(i);
...
function rr(n) {
  for (var e = xe(n), t = Xo(n); t && pm(t) && ot(t).position === "static"; )
    t = Xo(t);
  return t && (Ue(t) === "html" || Ue(t) === "body" && ot(t).position === "static") ? e : t || mm(n) || e;
}
function Bs(n) {
...
var ym = function(e, t) {
  ...
  })) : e, sc(typeof e != "number" ? e : oc(e, nr));
};
function vm(n) {
  var e, t = n.state, r = n.name, i = n.options, s = t.elements.arrow, o = t.modifiersData.popperOffsets, l = qe(t.placement), a = Bs(l), c = [me, Ae].indexOf(l) >= 0, u = c ? "height" : "width";
  if (!(!s || !o)) {
    var d = ym(i.padding, t), f = Ls(s), h = a === "y" ? pe : me, p = a === "y" ? Ee : Ae, m = t.rects.reference[u] + t.rects.reference[a] - o[a] - t.rects.popper[u], y = o[a] - t.rects.reference[a], v = rr(s), w = v ? a === "y" ? v.clientHeight || 0 : v.clientWidth || 0 : 0, C = m / 2 - y / 2, g = d[h], T = w - f[u] - d[p], k = w / 2 - f[u] / 2 + C, D = zn(g, k, T), z = a;
    t.modifiersData[r] = (e = {}, e[z] = D, e.centerOffset = D - k, e);
  }
}
function bm(n) {
  var e = n.state, t = n.options, r = t.element, i = r === void 0 ? "[data-popper-arrow]" : r;
  i != null && (typeof i == "string" && (i = e.elements.popper.querySelector(i), !i) || rc(e.elements.popper, i) && (e.elements.arrow = i));
}
const km = {
  name: "arrow",
  enabled: !0,
...
function Zo(n) {
  ...
  h = y.x, m = y.y;
  var v = o.hasOwnProperty("x"), w = o.hasOwnProperty("y"), C = me, g = pe, T = window;
  if (c) {
    var k = rr(t), D = "clientHeight", z = "clientWidth";
    if (k === xe(t) && (k = St(t), ot(k).position !== "static" && l === "absolute" && (D = "scrollHeight", z = "scrollWidth")), k = k, i === pe || (i === me || i === Ae) && s === Un) {
      g = Ee;
    ...
    if (i === me || (i === pe || i === Ee) && s === Un) {
      C = Ae;
      var B = d && k === T && T.visualViewport ? T.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        k[z]
      );
      h -= B - r.width, h *= a ? 1 : -1;
  ...
  if (h = j.x, m = j.y, a) {
    var _;
    return Object.assign({}, $, (_ = {}, _[g] = w ? "0" : "", _[C] = v ? "0" : "", _.transform = (T.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + m + "px)" : "translate3d(" + h + "px, " + m + "px, 0)", _));
  }
  return Object.assign({}, $, (e = {}, e[g] = w ? m + "px" : "", e[C] = v ? h + "px" : "", e.transform = "", e));
}
function Sm(n) {
  ...
  e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, Zo(Object.assign({}, c, {
    offsets: e.modifiersData.popperOffsets,
    position: e.options.strategy,
    adaptive: o,
    roundOffsets: a
  })))), e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, Zo(Object.assign({}, c, {
...
function Cm(n) {
  ...
  }), l && a.addEventListener("resize", t.update, br), function() {
    s && c.forEach(function(u) {
      u.removeEventListener("scroll", t.update, br);
...
function zs(n) {
  var e = xe(n), t = e.pageXOffset, r = e.pageYOffset;
  return {
    scrollLeft: t,
    scrollTop: r
  };
...
function Vs(n) {
  return bn(St(n)).left + zs(n).scrollLeft;
}
function Am(n, e) {
  var t = xe(n), r = St(n), i = t.visualViewport, s = r.clientWidth, o = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function Nm(n) {
  var e, t = St(n), r = zs(n), i = (e = n.ownerDocument) == null ? void 0 : e.body, s = Ft(t.scrollWidth, t.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0), o = Ft(t.scrollHeight, t.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0), l = -r.scrollLeft + Vs(n), a = -r.scrollTop;
...
function lc(n) {
  return ["html", "body", "#document"].indexOf(Ue(n)) >= 0 ? n.ownerDocument.body : Te(n) && Fs(n) ? n : lc(si(n));
}
function Vn(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = lc(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), s = xe(r), o = i ? [s].concat(s.visualViewport || [], Fs(r) ? r : []) : r, l = e.concat(o);
  return i ? l : (
...
function el(n, e, t) {
  return e === Qa ? ls(Am(n, t)) : Wt(e) ? Dm(e, t) : ls(Nm(St(n)));
}
function Im(n) {
  var e = Vn(si(n)), t = ["absolute", "fixed"].indexOf(ot(n).position) >= 0, r = t && Te(n) ? rr(n) : n;
  return Wt(r) ? e.filter(function(i) {
    return Wt(i) && rc(i, r) && Ue(i) !== "body";
  }) : [];
}
function Rm(n, e, t, r) {
  var i = e === "clippingParents" ? Im(n) : [].concat(e), s = [].concat(i, [t]), o = s[0], l = s.reduce(function(a, c) {
    var u = el(n, c, r);
    return a.top = Ft(u.top, a.top), a.right = $r(u.right, a.right), a.bottom = $r(u.bottom, a.bottom), a.left = Ft(u.left, a.left), a;
  }, el(n, o, r));
  return l.width = l.right - l.left, l.height = l.bottom - l.top, l.x = l.left, l.y = l.top, l;
}
function ac(n) {
  var e = n.reference, t = n.element, r = n.placement, i = r ? qe(r) : null, s = r ? kn(r) : null, o = e.x + e.width / 2 - t.width / 2, l = e.y + e.height / 2 - t.height / 2, a;
  switch (i) {
    case pe:
      a = {
        x: o,
...
function Gn(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, s = t.strategy, o = s === void 0 ? n.strategy : s, l = t.boundary, a = l === void 0 ? em : l, c = t.rootBoundary, u = c === void 0 ? Qa : c, d = t.elementContext, f = d === void 0 ? An : d, h = t.altBoundary, p = h === void 0 ? !1 : h, m = t.padding, y = m === void 0 ? 0 : m, v = sc(typeof y != "number" ? y : oc(y, nr)), w = f === An ? tm : An, C = n.rects.popper, g = n.elements[p ? w : f], T = Rm(Wt(g) ? g : g.contextElement || St(n.elements.popper), a, u, o), k = bn(n.elements.reference), D = ac({
    reference: k,
    element: C,
    strategy: "absolute",
    placement: i
  }), z = ls(Object.assign({}, C, D)), E = f === An ? z : k, B = {
    top: T.top - E.top + v.top,
    bottom: E.bottom - T.bottom + v.bottom,
    left: T.left - E.left + v.left,
    right: E.right - T.right + v.right
  }, $ = n.modifiersData.offset;
  if (f === An && $) {
    var j = $[i];
    Object.keys(B).forEach(function(_) {
      var ye = [Ae, Ee].indexOf(_) >= 0 ? 1 : -1, ve = [pe, Ee].indexOf(_) >= 0 ? "y" : "x";
      B[_] += j[ve] * ye;
    });
  }
  return B;
...
function Pm(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = t.boundary, s = t.rootBoundary, o = t.padding, l = t.flipVariations, a = t.allowedAutoPlacements, c = a === void 0 ? ec : a, u = kn(r), d = u ? l ? Yo : Yo.filter(function(p) {
    return kn(p) === u;
...
function Bm(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, s = i === void 0 ? !0 : i, o = t.altAxis, l = o === void 0 ? !0 : o, a = t.fallbackPlacements, c = t.padding, u = t.boundary, d = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, m = t.allowedAutoPlacements, y = e.options.placement, v = qe(y), w = v === y, C = a || (w || !p ? [Mr(y)] : Lm(y)), g = [y].concat(C).reduce(function(Ye, Ne) {
      return Ye.concat(qe(Ne) === Rs ? Pm(e, {
        placement: Ne,
        boundary: u,
        rootBoundary: d,
        padding: c,
    ...
    }, []), T = e.rects.reference, k = e.rects.popper, D = /* @__PURE__ */ new Map(), z = !0, E = g[0], B = 0; B < g.length; B++) {
      var $ = g[B], j = qe($), _ = kn($) === yn, ye = [pe, Ee].indexOf(j) >= 0, ve = ye ? "width" : "height", ne = Gn(e, {
        placement: $,
        boundary: u,
        rootBoundary: d,
        altBoundary: f,
        padding: c
      }), re = ye ? _ ? Ae : me : _ ? Ee : pe;
      T[ve] > k[ve] && (re = Mr(re));
      var Z = Mr(re), ze = [];
      if (s && ze.push(ne[j] <= 0), l && ze.push(ne[re] <= 0, ne[Z] <= 0), ze.every(function(Ye) {
        return Ye;
      })) {
        E = $, z = !1;
        break;
    ...
    if (z)
      for (var Ve = p ? 3 : 1, Mt = function(Ne) {
        var Xe = g.find(function(qt) {
          var Ze = D.get(qt);
          if (Ze)
            return Ze.slice(0, Ne).every(function(Kt) {
              return Kt;
            });
        });
        if (Xe)
...
function nl(n) {
  return [pe, Ae, Ee, me].some(function(e) {
    return n[e] >= 0;
  });
}
function Vm(n) {
  var e = n.state, t = n.name, r = e.rects.reference, i = e.rects.popper, s = e.modifiersData.preventOverflow, o = Gn(e, {
    elementContext: "reference"
  }), l = Gn(e, {
    altBoundary: !0
  }), a = tl(o, r), c = tl(l, i, s), u = nl(a), d = nl(c);
  e.modifiersData[t] = {
...
function Hm(n, e, t) {
  var r = qe(n), i = [me, pe].indexOf(r) >= 0 ? -1 : 1, s = typeof t == "function" ? t(Object.assign({}, e, {
    placement: n
  })) : t, o = s[0], l = s[1];
  return o = o || 0, l = (l || 0) * i, [me, Ae].indexOf(r) >= 0 ? {
    x: l,
    y: o
  } : {
    x: o,
...
function $m(n) {
  var e = n.state, t = n.options, r = n.name, i = t.offset, s = i === void 0 ? [0, 0] : i, o = ec.reduce(function(u, d) {
    return u[d] = Hm(d, e.rects, s), u;
...
function Km(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, s = i === void 0 ? !0 : i, o = t.altAxis, l = o === void 0 ? !1 : o, a = t.boundary, c = t.rootBoundary, u = t.altBoundary, d = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, m = p === void 0 ? 0 : p, y = Gn(e, {
    boundary: a,
    rootBoundary: c,
    padding: d,
    altBoundary: u
  }), v = qe(e.placement), w = kn(e.placement), C = !w, g = Bs(v), T = qm(g), k = e.modifiersData.popperOffsets, D = e.rects.reference, z = e.rects.popper, E = typeof m == "function" ? m(Object.assign({}, e.rects, {
    placement: e.placement
  })) : m, B = typeof E == "number" ? {
    mainAxis: E,
    altAxis: E
  ...
  if (k) {
    if (s) {
      var _, ye = g === "y" ? pe : me, ve = g === "y" ? Ee : Ae, ne = g === "y" ? "height" : "width", re = k[g], Z = re + y[ye], ze = re - y[ve], Ve = h ? -z[ne] / 2 : 0, Mt = w === yn ? D[ne] : z[ne], Fe = w === yn ? -z[ne] : -D[ne], Ct = e.elements.arrow, Ye = h && Ct ? Ls(Ct) : {
        width: 0,
        height: 0
      }, Ne = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ic(), Xe = Ne[ye], qt = Ne[ve], Ze = zn(0, D[ne], Ye[ne]), Kt = C ? D[ne] / 2 - Ve - Ze - Xe - B.mainAxis : Mt - Ze - Xe - B.mainAxis, lt = C ? -D[ne] / 2 + Ve + Ze + qt + B.mainAxis : Fe + Ze + qt + B.mainAxis, Jt = e.elements.arrow && rr(e.elements.arrow), ir = Jt ? g === "y" ? Jt.clientTop || 0 : Jt.clientLeft || 0 : 0, Sn = (_ = $ == null ? void 0 : $[g]) != null ? _ : 0, sr = re + Kt - Sn - ir, or = re + lt - Sn, Mn = zn(h ? $r(Z, sr) : Z, re, h ? Ft(ze, or) : ze);
      k[g] = Mn, j[g] = Mn - re;
    }
    if (l) {
      var Cn, lr = g === "x" ? pe : me, ar = g === "x" ? Ee : Ae, Qe = k[T], at = T === "y" ? "height" : "width", On = Qe + y[lr], Ot = Qe - y[ar], Tn = [pe, me].indexOf(v) !== -1, cr = (Cn = $ == null ? void 0 : $[T]) != null ? Cn : 0, ur = Tn ? On : Qe - D[at] - z[at] - cr + B.altAxis, dr = Tn ? Qe + D[at] + z[at] - cr - B.altAxis : Ot, fr = h && Tn ? gm(ur, Qe, dr) : zn(h ? ur : On, Qe, h ? dr : Ot);
      k[T] = fr, j[T] = fr - Qe;
    }
    e.modifiersData[r] = j;
  }
...
function Xm(n, e, t) {
  t === void 0 && (t = !1);
  var r = Te(e), i = Te(e) && Ym(e), s = St(e), o = bn(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  return (r || !r && !t) && ((Ue(e) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  Fs(s)) && (l = Gm(e)), Te(e) ? (a = bn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : s && (a.x = Vs(s))), {
...
function ng(n) {
  n === void 0 && (n = {});
  var e = n, t = e.defaultModifiers, r = t === void 0 ? [] : t, i = e.defaultOptions, s = i === void 0 ? rl : i;
  return function(l, a, c) {
    c === void 0 && (c = s);
    var u = {
      placement: "bottom",
      orderedModifiers: [],
      options: Object.assign({}, rl, s),
      modifiersData: {},
      elements: {
        reference: l,
        popper: a
      ...
      setOptions: function(v) {
        ...
        var C = Qm(tg([].concat(r, u.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          var v = u.elements, w = v.reference, C = v.popper;
          if (il(w, C)) {
            u.rects = {
              reference: Xm(w, rr(C), u.options.strategy === "fixed"),
              popper: Ls(C)
            ...
            for (var g = 0; g < u.orderedModifiers.length; g++) {
              ...
              var T = u.orderedModifiers[g], k = T.fn, D = T.options, z = D === void 0 ? {} : D, E = T.name;
    ...
    function p() {
      u.orderedModifiers.forEach(function(y) {
        var v = y.name, w = y.options, C = w === void 0 ? {} : w, g = y.effect;
...
var rg = [Om, Wm, Mm, tc, jm, zm, Jm, km, Fm], ig = /* @__PURE__ */ ng({
  defaultModifiers: rg
}), sg = "tippy-box", cc = "tippy-content", og = "tippy-backdrop", uc = "tippy-arrow", dc = "tippy-svg-arrow", Et = {
  passive: !0,
  capture: !0
}, fc = function() {
...
function fg(n) {
  return Hs(n, "NodeList");
}
function hg(n) {
  return Hs(n, "MouseEvent");
}
function pg(n) {
  return !!(n && n._tippy && n._tippy.reference === n);
}
function mg(n) {
  return Yn(n) ? [n] : fg(n) ? jr(n) : Array.isArray(n) ? n : jr(document.querySelectorAll(n));
}
function Ii(n, e) {
...
function yg(n, e) {
  ...
  return n.every(function(i) {
    var s = i.popperRect, o = i.popperState, l = i.props, a = l.interactiveBorder, c = dg(o.placement), u = o.modifiersData.offset;
    if (!u)
      return !0;
...
function vg() {
  $e.isTouch || ($e.isTouch = !0, window.performance && document.addEventListener("mousemove", pc));
}
function pc() {
  var n = performance.now();
  n - ul < 20 && ($e.isTouch = !1, document.removeEventListener("mousemove", pc)), ul = n;
}
function bg() {
...
function kg() {
  document.addEventListener("touchstart", vg, Et), window.addEventListener("blur", bg);
}
var xg = typeof window < "u" && typeof document < "u", wg = xg ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Zt(n) {
...
function rt(n, e) {
  if (n && !Xn.has(e)) {
    var t;
    Xn.add(e), (t = console).warn.apply(t, mc(e));
  }
}
function as(n, e) {
  if (n && !Xn.has(e)) {
    var t;
    Xn.add(e), (t = console).error.apply(t, mc(e));
  }
}
function Cg(n) {
  var e = !n, t = Object.prototype.toString.call(n) === "[object Object]" && !n.addEventListener;
  as(e, ["tippy() was passed", "`" + String(n) + "`", "as its targets (first) argument. Valid types are: String, Element,", "Element[], or NodeList."].join(" ")), as(t, ["tippy() was passed a plain object which is not supported as an argument", "for virtual positioning. Use props.getReferenceClientRect instead."].join(" "));
}
var gc = {
  animateFill: !1,
  followCursor: !1,
  ...
  triggerTarget: null
}, gc, Og), Tg = Object.keys(ke), Eg = function(e) {
...
function yc(n) {
  var e = n.plugins || [], t = e.reduce(function(r, i) {
    ...
    if (s) {
      var l;
      r[s] = n[s] !== void 0 ? n[s] : (l = ke[s]) != null ? l : o;
    }
    return r;
  }, {});
...
function Ag(n, e) {
  var t = e ? Object.keys(yc(Object.assign({}, ke, {
    plugins: e
  }))) : Tg, r = t.reduce(function(i, s) {
...
function fl(n, e) {
  var t = Object.assign({}, e, {
    content: hc(e.content, [n])
  }, e.ignoreAttributes ? {} : Ag(n, e.plugins));
  return t.aria = Object.assign({}, ke.aria, t.aria), t.aria = {
...
function vc(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = ag(ke, Object.keys(gc)), s = !lg(i, r);
...
function hl(n) {
  var e = Fn();
  return n === !0 ? e.className = uc : (e.className = dc, Yn(n) ? e.appendChild(n) : cs(e, n)), e;
}
function pl(n, e) {
  Yn(e.content) ? (cs(n, ""), n.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? cs(n, e.content) : n.textContent = e.content);
}
function us(n) {
  ...
  return {
    ...
    content: t.find(function(r) {
      return r.classList.contains(cc);
    }),
    arrow: t.find(function(r) {
      return r.classList.contains(uc) || r.classList.contains(dc);
    }),
    backdrop: t.find(function(r) {
      return r.classList.contains(og);
    })
  };
}
function bc(n) {
  var e = Fn(), t = Fn();
  t.className = sg, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = Fn();
  r.className = cc, r.setAttribute("data-state", "hidden"), pl(r, n.props), e.appendChild(t), t.appendChild(r), i(n.props, n.props);
  function i(s, o) {
    var l = us(e), a = l.box, c = l.content, u = l.arrow;
    o.theme ? a.setAttribute("data-theme", o.theme) : a.removeAttribute("data-theme"), typeof o.animation == "string" ? a.setAttribute("data-animation", o.animation) : a.removeAttribute("data-animation"), o.inertia ? a.setAttribute("data-inertia", "") : a.removeAttribute("data-inertia"), a.style.maxWidth = typeof o.maxWidth == "number" ? o.maxWidth + "px" : o.maxWidth, o.role ? a.setAttribute("role", o.role) : a.removeAttribute("role"), (s.content !== o.content || s.allowHTML !== o.allowHTML) && pl(c, n.props), o.arrow ? u ? s.arrow !== o.arrow && (a.removeChild(u), a.appendChild(hl(o.arrow))) : a.appendChild(hl(o.arrow)) : u && a.removeChild(u);
  }
  return {
    popper: e,
    onUpdate: i
...
var Dg = 1, kr = [], Pi = [];
function Ig(n, e) {
  var t = fl(n, Object.assign({}, ke, yc(ll(e)))), r, i, s, o = !1, l = !1, a = !1, c = !1, u, d, f, h = [], p = sl(sr, t.interactiveDebounce), m, y = Dg++, v = null, w = ug(t.plugins), C = {
  ...
  if (!t.render)
    return process.env.NODE_ENV !== "production" && as(!0, "render() function has not been supplied."), g;
  var T = t.render(g), k = T.popper, D = T.onUpdate;
  k.setAttribute("data-tippy-root", ""), k.id = "tippy-" + g.id, g.popper = k, n._tippy = g, k._tippy = g;
  var z = w.map(function(b) {
    return b.fn(g);
  }), E = n.hasAttribute("aria-expanded");
  return Jt(), Ve(), re(), Z("onCreate", [g]), t.showOnCreate && On(), k.addEventListener("mouseenter", function() {
    g.props.interactive && g.state.isVisible && g.clearDelayTimeouts();
  }), k.addEventListener("mouseleave", function() {
    g.props.interactive && g.props.trigger.indexOf("mouseenter") >= 0 && ye().addEventListener("mousemove", p);
  }), g;
  function B() {
    var b = g.props.touch;
  ...
  function ye() {
    var b = _().parentNode;
    return b ? gg(b) : document;
  }
  function ve() {
    return us(k);
  }
  function ne(b) {
    return g.state.isMounted && !g.state.isVisible || $e.isTouch || u && u.type === "focus" ? 0 : Di(g.props.delay, b ? 0 : 1, ke.delay);
  }
  function re(b) {
    b === void 0 && (b = !1), k.style.pointerEvents = g.props.interactive && !b ? "" : "none", k.style.zIndex = "" + g.props.zIndex;
  }
  function Z(b, O, N) {
    if (N === void 0 && (N = !0), z.forEach(function(L) {
      L[b] && L[b].apply(L, O);
    }), N) {
      var V;
      (V = g.props)[b].apply(V, O);
    }
  }
  function ze() {
    var b = g.props.aria;
    if (b.content) {
      var O = "aria-" + b.content, N = k.id, V = tn(g.props.triggerTarget || n);
      V.forEach(function(L) {
        var ae = L.getAttribute(O);
        if (g.state.isVisible)
          L.setAttribute(O, ae ? ae + " " + N : N);
        else {
          var we = ae && ae.replace(N, "").trim();
          we ? L.setAttribute(O, we) : L.removeAttribute(O);
        }
      });
    }
  }
  function Ve() {
    if (!(E || !g.props.aria.expanded)) {
      var b = tn(g.props.triggerTarget || n);
      b.forEach(function(O) {
        g.props.interactive ? O.setAttribute("aria-expanded", g.state.isVisible && O === _() ? "true" : "false") : O.removeAttribute("aria-expanded");
      });
    }
  }
  function Mt() {
    ye().removeEventListener("mousemove", p), kr = kr.filter(function(b) {
      return b !== p;
    });
  }
  function Fe(b) {
    if (!($e.isTouch && (a || b.type === "mousedown"))) {
      var O = b.composedPath && b.composedPath()[0] || b.target;
      if (!(g.props.interactive && cl(k, O))) {
        if (tn(g.props.triggerTarget || n).some(function(N) {
          return cl(N, O);
        })) {
          if ($e.isTouch || g.state.isVisible && g.props.trigger.indexOf("click") >= 0)
            return;
        } else
          Z("onClickOutside", [g, b]);
  ...
  function Ne() {
    var b = ye();
    b.addEventListener("mousedown", Fe, !0), b.addEventListener("touchend", Fe, Et), b.addEventListener("touchstart", Ye, Et), b.addEventListener("touchmove", Ct, Et);
  }
  function Xe() {
    var b = ye();
    b.removeEventListener("mousedown", Fe, !0), b.removeEventListener("touchend", Fe, Et), b.removeEventListener("touchstart", Ye, Et), b.removeEventListener("touchmove", Ct, Et);
  }
  function qt(b, O) {
    Kt(b, function() {
  ...
  function Kt(b, O) {
    var N = ve().box;
    function V(L) {
      L.target === N && (Ri(N, "remove", V), O());
    }
    if (b === 0)
      return O();
    Ri(N, "remove", d), Ri(N, "add", V), d = V;
  }
  function lt(b, O, N) {
    N === void 0 && (N = !1);
    var V = tn(g.props.triggerTarget || n);
    V.forEach(function(L) {
      L.addEventListener(b, O, N), h.push({
        node: L,
        eventType: b,
        handler: O,
        options: N
  ...
  function Jt() {
    $() && (lt("touchstart", Sn, {
      ...
      passive: !0
    })), cg(g.props.trigger).forEach(function(b) {
      if (b !== "manual")
        switch (lt(b, Sn), b) {
          case "mouseenter":
            lt("mouseleave", or);
  ...
  function ir() {
    h.forEach(function(b) {
      var O = b.node, N = b.eventType, V = b.handler, L = b.options;
      O.removeEventListener(N, V, L);
    }), h = [];
  }
  function Sn(b) {
    var O, N = !1;
    if (!(!g.state.isEnabled || Cn(b) || l)) {
      var V = ((O = u) == null ? void 0 : O.type) === "focus";
      u = b, m = b.currentTarget, Ve(), !g.state.isVisible && hg(b) && kr.forEach(function(L) {
        return L(b);
      }), b.type === "click" && (g.props.trigger.indexOf("mouseenter") < 0 || o) && g.props.hideOnClick !== !1 && g.state.isVisible ? N = !0 : On(b), b.type === "click" && (o = !N), N && !V && Ot(b);
    }
  }
  function sr(b) {
    var O = b.target, N = _().contains(O) || k.contains(O);
    if (!(b.type === "mousemove" && N)) {
      var V = at().concat(k).map(function(L) {
        var ae, we = L._tippy, Ut = (ae = we.popperInstance) == null ? void 0 : ae.state;
        return Ut ? {
  ...
  function or(b) {
    var O = Cn(b) || g.props.trigger.indexOf("click") >= 0 && o;
    if (!O) {
  ...
  function Mn(b) {
    g.props.trigger.indexOf("focusin") < 0 && b.target !== _() || g.props.interactive && b.relatedTarget && k.contains(b.relatedTarget) || Ot(b);
  }
  function Cn(b) {
    return $e.isTouch ? $() !== b.type.indexOf("touch") >= 0 : !1;
  }
  function lr() {
    ar();
    var b = g.props, O = b.popperOptions, N = b.placement, V = b.offset, L = b.getReferenceClientRect, ae = b.moveTransition, we = j() ? us(k).arrow : null, Ut = L ? {
      getBoundingClientRect: L,
      contextElement: L.contextElement || _()
    } : n, Ws = {
      name: "$$tippy",
      enabled: !0,
      phase: "beforeWrite",
      ...
      fn: function(hr) {
        ...
        if (j()) {
          ...
          ["placement", "reference-hidden", "escaped"].forEach(function(pr) {
            pr === "placement" ? ai.setAttribute("data-placement", Gt.placement) : Gt.attributes.popper["data-popper-" + pr] ? ai.setAttribute("data-" + pr, "") : ai.removeAttribute("data-" + pr);
    ...
    }), Tt.push.apply(Tt, (O == null ? void 0 : O.modifiers) || []), g.popperInstance = ig(Ut, k, Object.assign({}, O, {
      placement: N,
      onFirstUpdate: f,
      modifiers: Tt
    }));
  ...
  function Qe() {
    var b = g.props.appendTo, O, N = _();
    g.props.interactive && b === fc || b === "parent" ? O = N.parentNode : O = hc(b, [N]), O.contains(k) || O.appendChild(k), g.state.isMounted = !0, lr(), process.env.NODE_ENV !== "production" && rt(g.props.interactive && b === ke.appendTo && N.nextElementSibling !== k, ["Interactive tippy element may not be accessible via keyboard", "navigation because it is not directly after the reference element", "in the DOM source order.", `
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function On(b) {
    g.clearDelayTimeouts(), b && Z("onTrigger", [g, b]), Ne();
    var O = ne(!0), N = B(), V = N[0], L = N[1];
    $e.isTouch && V === "hold" && L && (O = L), O ? r = setTimeout(function() {
      g.show();
    }, O) : g.show();
  }
  function Ot(b) {
    if (g.clearDelayTimeouts(), Z("onUntrigger", [g, b]), !g.state.isVisible) {
      Xe();
      return;
    }
  ...
  function dr(b) {
    if (process.env.NODE_ENV !== "production" && rt(g.state.isDestroyed, Zt("setProps")), !g.state.isDestroyed) {
      Z("onBeforeUpdate", [g, b]), ir();
      var O = g.props, N = fl(n, Object.assign({}, O, ll(b), {
        ignoreAttributes: !0
      }));
      g.props = N, Jt(), O.interactiveDebounce !== N.interactiveDebounce && (Mt(), p = sl(sr, N.interactiveDebounce)), O.triggerTarget && !N.triggerTarget ? tn(O.triggerTarget).forEach(function(V) {
        V.removeAttribute("aria-expanded");
      }) : N.triggerTarget && n.removeAttribute("aria-expanded"), Ve(), re(), D && D(O, N), g.popperInstance && (lr(), at().forEach(function(V) {
  ...
  function Bc() {
    process.env.NODE_ENV !== "production" && rt(g.state.isDestroyed, Zt("show"));
    var b = g.state.isVisible, O = g.state.isDestroyed, N = !g.state.isEnabled, V = $e.isTouch && !g.props.touch, L = Di(g.props.duration, 0, ke.duration);
    if (!(b || O || N || V) && !_().hasAttribute("disabled") && (Z("onShow", [g], !1), g.props.onShow(g) !== !1)) {
      if (g.state.isVisible = !0, j() && (k.style.visibility = "visible"), re(), Ne(), g.state.isMounted || (k.style.transition = "none"), j()) {
        var ae = ve(), we = ae.box, Ut = ae.content;
        Ii([we, Ut], 0);
      }
      f = function() {
        var Tt;
        if (!(!g.state.isVisible || c)) {
          if (c = !0, k.offsetHeight, k.style.transition = g.props.moveTransition, j() && g.props.animation) {
            var li = ve(), hr = li.box, Gt = li.content;
            Ii([hr, Gt], L), al([hr, Gt], "visible");
          }
          ze(), Ve(), ol(Pi, g), (Tt = g.popperInstance) == null || Tt.forceUpdate(), Z("onMount", [g]), g.props.animation && j() && Ze(L, function() {
  ...
  function zc() {
    process.env.NODE_ENV !== "production" && rt(g.state.isDestroyed, Zt("hide"));
    var b = !g.state.isVisible, O = g.state.isDestroyed, N = !g.state.isEnabled, V = Di(g.props.duration, 1, ke.duration);
    if (!(b || O || N) && (Z("onHide", [g], !1), g.props.onHide(g) !== !1)) {
      if (g.state.isVisible = !1, g.state.isShown = !1, c = !1, o = !1, j() && (k.style.visibility = "hidden"), Mt(), Xe(), re(!0), j()) {
        var L = ve(), ae = L.box, we = L.content;
        g.props.animation && (Ii([ae, we], V), al([ae, we], "hidden"));
      }
      ze(), Ve(), g.props.animation ? j() && qt(V, g.unmount) : g.unmount();
    }
  }
  function Vc(b) {
    process.env.NODE_ENV !== "production" && rt(g.state.isDestroyed, Zt("hideWithInteractivity")), ye().addEventListener("mousemove", p), ol(kr, p), p(b);
  }
  function Fc() {
    process.env.NODE_ENV !== "production" && rt(g.state.isDestroyed, Zt("unmount")), g.state.isVisible && g.hide(), g.state.isMounted && (ar(), at().forEach(function(b) {
      b._tippy.unmount();
    }), k.parentNode && k.parentNode.removeChild(k), Pi = Pi.filter(function(b) {
      return b !== g;
    }), g.state.isMounted = !1, Z("onHidden", [g]));
  }
  function Hc() {
    process.env.NODE_ENV !== "production" && rt(g.state.isDestroyed, Zt("destroy")), !g.state.isDestroyed && (g.clearDelayTimeouts(), g.unmount(), ir(), delete n._tippy, g.state.isDestroyed = !0, Z("onDestroy", [g]));
  }
}
function wn(n, e) {
  e === void 0 && (e = {});
  var t = ke.plugins.concat(e.plugins || []);
  process.env.NODE_ENV !== "production" && (Cg(n), vc(e, t)), kg();
...
class Rg {
  constructor({ editor: e, element: t, view: r, tippyOptions: i = {}, updateDelay: s = 250, shouldShow: o }) {
    this.preventHide = !1, this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
      const { doc: d, selection: f } = a, { empty: h } = f, p = !d.textBetween(c, u).length && Ns(a.selection), m = this.element.contains(document.activeElement);
...
class Pg {
  ...
  update(e, t) {
    ...
    (i = this.tippy) === null || i === void 0 || i.setProps({
      getReferenceClientRect: ((s = this.tippyOptions) === null || s === void 0 ? void 0 : s.getReferenceClientRect) || (() => Xa(e, c, u))
    }), this.show();
  }
  show() {
    var e;
...
Be({
  ...
  setup(n, { slots: e }) {
    ...
    return Cl(() => {
      ...
      var r;
      return Rt("div", { ref: t }, (r = e.default) === null || r === void 0 ? void 0 : r.call(e));
    };
  }
});
function ml(n) {
...
class Lg extends Xp {
  constructor(e = {}) {
    return super(e), this.vueRenderers = Wc(/* @__PURE__ */ new Map()), this.contentComponent = null, this.reactiveState = ml(this.view.state), this.reactiveExtensionStorage = ml(this.extensionStorage), this.on("transaction", () => {
...
const Bg = Be({
  ...
  setup(n) {
    ...
    return Jc(() => {
      const r = n.editor;
      r && r.options.element && e.value && Uc(() => {
...
const zg = /^\s*>\s$/, Vg = oe.create({
...
}), Fg = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Hg = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, $g = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, jg = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, _g = Le.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Wg.name, this.editor.getAttributes(gl.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (n = Jn({
      ...
      getAttributes: () => this.editor.getAttributes(gl.name),
      editor: this.editor
    })), [
      n
    ];
  }
}), Kg = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))$/, Jg = /(?:^|\s)(`(?!\s+`)((?:[^`]+))`(?!\s+`))/g, Ug = Le.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  dragover(e) {
    ...
    if (t && !s) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = Gl(this.editorView.state.doc, o, this.editorView.dragging.slice);
        l != null && (o = l);
      }
...
function a0(n) {
  ...
  return e.className = "ProseMirror-gapcursor", J.create(n.doc, [Ce.widget(n.selection.head, e, { key: "gapcursor" })]);
}
const c0 = se.create({
  name: "gapCursor",
  addProseMirrorPlugins() {
...
var _r = 200, Y = function() {
};
Y.prototype.append = function(e) {
  return e.length ? (e = Y.from(e), !this.length && e || e.length < _r && this.leafAppend(e) || this.length < _r && e.leafPrepend(this) || this.appendInner(e)) : this;
};
...
Y.from = function(e) {
  return e instanceof Y ? e : e && e.length ? new wc(e) : Y.empty;
};
...
class Ie {
  ...
  popEvent(e, t) {
    ...
    return this.items.forEach((d, f) => {
      ...
      if (i) {
        ...
        h && o.maybeStep(h).doc && (p = o.mapping.maps[o.mapping.maps.length - 1], c.push(new He(p, void 0, void 0, c.length + u.length))), s--, p && i.appendMap(p, s);
      } else
        o.maybeStep(d.step);
      if (d.selection)
  ...
  addTransform(e, t, r, i) {
    ...
    for (let u = 0; u < e.steps.length; u++) {
      let d = e.steps[u].invert(e.docs[u]), f = new He(e.mapping.maps[u], d, t), h;
      (h = a && a.merge(f)) && (f = h, u ? s.pop() : l = l.slice(0, l.length - 1)), s.push(f), t && (o++, t = void 0), i || (a = f);
    }
    let c = o - r.depth;
    return c > m0 && (l = p0(l, c), o -= c), new Ie(l.append(s), o);
  }
  remapping(e, t) {
    let r = new sn();
  ...
  addMaps(e) {
    return this.eventCount == 0 ? this : new Ie(this.items.append(e.map((t) => new He(t))), this.eventCount);
  }
  ...
  rebased(e, t) {
    ...
    this.items.forEach((f) => {
      ...
      if (f.step) {
        ...
        y && l++, r.push(new He(p, m, y));
      } else
        r.push(new He(p));
    }, i);
    let c = [];
    for (let f = t; f < o; f++)
      c.push(new He(s.maps[f]));
    let u = this.items.slice(0, i).append(c).append(r), d = new Ie(u, l);
    return d.emptyItemCount() > h0 && (d = d.compress(this.items.length - r.length)), d;
  }
  emptyItemCount() {
    let e = 0;
    ...
    return this.items.forEach((o, l) => {
      if (l >= e)
        ...
        if (r--, c && t.appendMap(c, r), a) {
          ...
          u && s++;
          let d = new He(c.invert(), a, u), f, h = i.length - 1;
          (f = i.length && i[h].merge(d)) ? i[h] = f : i.push(d);
        }
      } else o.map && r--;
    }, this.items.length, 0), new Ie(Y.from(i.reverse()), s);
  }
}
Ie.empty = new Ie(Y.empty, 0);
function p0(n, e) {
  let t;
...
class He {
  ...
  merge(e) {
    if (this.step && e.step && !e.selection) {
      ...
      if (t)
        return new He(t.getMap().invert(), t, this.selection);
    }
  }
}
class dt {
...
function g0(n, e, t, r) {
  ...
  t.getMeta(b0) && (n = new dt(n.done, n.undone, null, 0, -1));
  let o = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (o && o.getMeta(Ht))
    return o.getMeta(Ht).redo ? new dt(n.done.addTransform(t, void 0, r, Cr(e)), n.undone, vl(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new dt(n.done, n.undone.addTransform(t, void 0, r, Cr(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !o && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !y0(t, n.prevRanges)), c = o ? Li(n.prevRanges, t.mapping) : vl(t.mapping.maps[t.steps.length - 1]);
    return new dt(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, Cr(e)), Ie.empty, c, t.time, l ?? n.prevComposition);
  } else return (s = t.getMeta("rebased")) ? new dt(n.done.rebased(t, s), n.undone.rebased(t, s), Li(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new dt(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), Li(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function y0(n, e) {
  if (!e)
    return !1;
...
function v0(n, e, t) {
  let r = Cr(e), i = Ht.get(e).spec.config, s = (t ? n.undone : n.done).popEvent(e, r);
  if (!s)
    return null;
...
const Ht = new Ge("history"), b0 = new Ge("closeHistory");
function k0(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new dt(Ie.empty, Ie.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return g0(t, r, e, n);
      }
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? Mc : r == "historyRedo" ? Cc : null;
...
const Mc = Sc(!1, !0), Cc = Sc(!0, !0), x0 = se.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
  ...
  addCommands() {
    return {
      undo: () => ({ state: n, dispatch: e }) => Mc(n, e),
      redo: () => ({ state: n, dispatch: e }) => Cc(n, e)
    };
  },
  addProseMirrorPlugins() {
    return [
...
}), S0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, M0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, C0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, O0 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, T0 = Le.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(E0.name, this.editor.getAttributes(kl.name)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (n = Jn({
      ...
      keepMarks: this.options.keepMarks,
      keepAttributes: this.options.keepAttributes,
      getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(kl.name) }),
      joinPredicate: (e, t) => t.childCount + t.attrs.start === +e[1],
      editor: this.editor
    })), [
      n
...
}), D0 = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, I0 = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, R0 = Le.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addExtensions() {
    ...
    const w = [];
    return this.options.blockquote !== !1 && w.push(Vg.configure((n = this.options) === null || n === void 0 ? void 0 : n.blockquote)), this.options.bold !== !1 && w.push(_g.configure((e = this.options) === null || e === void 0 ? void 0 : e.bold)), this.options.bulletList !== !1 && w.push(qg.configure((t = this.options) === null || t === void 0 ? void 0 : t.bulletList)), this.options.code !== !1 && w.push(Ug.configure((r = this.options) === null || r === void 0 ? void 0 : r.code)), this.options.codeBlock !== !1 && w.push(Xg.configure((i = this.options) === null || i === void 0 ? void 0 : i.codeBlock)), this.options.document !== !1 && w.push(Zg.configure((s = this.options) === null || s === void 0 ? void 0 : s.document)), this.options.dropcursor !== !1 && w.push(t0.configure((o = this.options) === null || o === void 0 ? void 0 : o.dropcursor)), this.options.gapcursor !== !1 && w.push(c0.configure((l = this.options) === null || l === void 0 ? void 0 : l.gapcursor)), this.options.hardBreak !== !1 && w.push(u0.configure((a = this.options) === null || a === void 0 ? void 0 : a.hardBreak)), this.options.heading !== !1 && w.push(d0.configure((c = this.options) === null || c === void 0 ? void 0 : c.heading)), this.options.history !== !1 && w.push(x0.configure((u = this.options) === null || u === void 0 ? void 0 : u.history)), this.options.horizontalRule !== !1 && w.push(w0.configure((d = this.options) === null || d === void 0 ? void 0 : d.horizontalRule)), this.options.italic !== !1 && w.push(T0.configure((f = this.options) === null || f === void 0 ? void 0 : f.italic)), this.options.listItem !== !1 && w.push(Za.configure((h = this.options) === null || h === void 0 ? void 0 : h.listItem)), this.options.orderedList !== !1 && w.push(A0.configure((p = this.options) === null || p === void 0 ? void 0 : p.orderedList)), this.options.paragraph !== !1 && w.push(N0.configure((m = this.options) === null || m === void 0 ? void 0 : m.paragraph)), this.options.strike !== !1 && w.push(R0.configure((y = this.options) === null || y === void 0 ? void 0 : y.strike)), this.options.text !== !1 && w.push(P0.configure((v = this.options) === null || v === void 0 ? void 0 : v.text)), w;
  }
}), Oc = () => {
  const n = ci("majorEditor"), e = ci("editor"), t = ci("content");
  return {
    majorEditor: n,
    editor: e,
    content: t
  };
}, js = (n) => (Xc("data-v-4fee0c3b"), n = n(), Zc(), n), B0 = { class: "major-editor-toolkit__group" }, z0 = /* @__PURE__ */ ps('<li class="icon_item" data-v-4fee0c3b><svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="200" height="200" data-v-4fee0c3b><path d="M223.300267 221.320533h410.555733c214.493867 0 388.437333 173.192533 388.437333 386.798934 0 213.674667-173.943467 386.8672-388.437333 386.8672H116.053333a64.580267 64.580267 0 0 1-64.7168-64.512c0-35.566933 29.013333-64.443733 64.7168-64.443734h517.802667a258.389333 258.389333 0 0 0 258.935467-257.911466 258.389333 258.389333 0 0 0-258.935467-257.8432h-415.061333L293.546667 424.823467a64.3072 64.3072 0 0 1-28.672 108.7488 64.853333 64.853333 0 0 1-62.941867-17.6128L19.114667 333.687467a64.375467 64.375467 0 0 1 0-91.204267L201.9328 60.074667a64.9216 64.9216 0 0 1 91.613867 0c25.258667 25.122133 25.258667 65.9456 0 91.136l-70.314667 70.0416z" fill="#333333" data-v-4fee0c3b></path></svg></li><li class="icon_item" data-v-4fee0c3b><svg viewBox="0 0 1092 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="200" height="200" data-v-4fee0c3b><path d="M828.893867 220.091733H418.338133C203.844267 220.091733 29.969067 393.216 29.969067 606.890667c0 213.674667 173.8752 386.798933 388.369066 386.798933h517.802667a64.580267 64.580267 0 0 0 64.7168-64.443733 64.580267 64.580267 0 0 0-64.7168-64.443734H418.338133A258.389333 258.389333 0 0 1 159.402667 606.890667a258.389333 258.389333 0 0 1 258.935466-257.911467h415.1296l-74.888533 74.615467a64.3072 64.3072 0 0 0 28.672 108.7488 64.853333 64.853333 0 0 0 62.941867-17.6128l183.022933-182.272a64.375467 64.375467 0 0 0 0-91.272534L850.193067 58.914133a64.9216 64.9216 0 0 0-91.5456 0 64.3072 64.3072 0 0 0 0 91.136l70.314666 70.0416z" fill="#333333" data-v-4fee0c3b></path></svg></li>', 2), V0 = /* @__PURE__ */ js(() => /* @__PURE__ */ Me("li", { class: "icon_item" }, [
  /* @__PURE__ */ Me("svg", {
  ...
  /* @__PURE__ */ Me("svg", {
    ...
    /* @__PURE__ */ Me("path", {
      d: "M91.989333 768.981333h840.021334v64H91.989333z",
      fill: "#191919"
    })
  ])
], -1)), $0 = /* @__PURE__ */ js(() => /* @__PURE__ */ Me("li", { class: "icon_item" }, [
  /* @__PURE__ */ Me("svg", {
    viewBox: "0 0 1024 1024",
    version: "1.1",
    xmlns: "http://www.w3.org/2000/svg",
  ...
  ...j0,
  setup(n) {
    const { majorEditor: e } = Oc();
    function t() {
      console.log(e, 55555);
    }
    return (r, i) => (fs(), hs("ul", B0, [
      z0,
      V0,
      F0,
      H0,
      $0,
      Me("li", { class: "icon_item" }, [
        Me("button", { onClick: t }, "调用插件方法")
      ])
    ]));
  }
}), Tc = (n, e) => {
  ...
  for (const [r, i] of e)
    t[r] = i;
  return t;
}, W0 = /* @__PURE__ */ Tc(_0, [["__scopeId", "data-v-4fee0c3b"]]), q0 = { class: "rich-content-editor__wrap" }, K0 = Be({
  name: "RichEditor"
}), J0 = /* @__PURE__ */ Be({
  ...K0,
  setup(n) {
    const { editor: e } = Oc();
    return (t, r) => (fs(), hs("div", q0, [
      Vi(zi(Bg), { editor: zi(e) }, null, 8, ["editor"])
    ]));
  }
}), U0 = /* @__PURE__ */ Tc(J0, [["__scopeId", "data-v-c7f09b79"]]);
function G0(n) {
  return n && n.__esModule && Object.prototype.hasOwnProperty.call(n, "default") ? n.default : n;
}
var _s = { exports: {} }, cn = typeof Reflect == "object" ? Reflect : null, wl = cn && typeof cn.apply == "function" ? cn.apply : function(e, t, r) {
  return Function.prototype.apply.call(e, t, r);
}, Or;
cn && typeof cn.ownKeys == "function" ? Or = cn.ownKeys : Object.getOwnPropertySymbols ? Or = function(e) {
...
H.prototype.emit = function(e) {
  ...
  if (typeof a == "function")
    ...
    for (var c = a.length, u = Pc(a, c), r = 0; r < c; ++r)
      wl(u[r], this, t);
  return !0;
};
function Nc(n, e, t, r) {
  var i, s, o;
  if (oi(t), s = n._events, s === void 0 ? (s = n._events = /* @__PURE__ */ Object.create(null), n._eventsCount = 0) : (s.newListener !== void 0 && (n.emit(
    "newListener",
    e,
    t.listener ? t.listener : t
  ), s = n._events), o = s[e]), o === void 0)
    o = s[e] = t, ++n._eventsCount;
  else if (typeof o == "function" ? o = s[e] = r ? [t, o] : [o, t] : r ? o.unshift(t) : o.push(t), i = Ac(n), i > 0 && o.length > i && !o.warned) {
    o.warned = !0;
    ...
    l.name = "MaxListenersExceededWarning", l.emitter = n, l.type = e, l.count = o.length, Y0(l);
  }
  return n;
}
...
function Dc(n, e, t) {
  var r = { fired: !1, wrapFn: void 0, target: n, type: e, listener: t }, i = X0.bind(r);
  return i.listener = t, r.wrapFn = i, i;
}
H.prototype.once = function(e, t) {
  return oi(t), this.on(e, Dc(this, e, t)), this;
};
H.prototype.prependOnceListener = function(e, t) {
  return oi(t), this.prependListener(e, Dc(this, e, t)), this;
};
H.prototype.removeListener = function(e, t) {
  var r, i, s, o, l;
  if (oi(t), i = this._events, i === void 0)
    return this;
  if (r = i[e], r === void 0)
    return this;
  if (r === t || r.listener === t)
    ...
    if (s < 0)
      return this;
    s === 0 ? r.shift() : Z0(r, s), r.length === 1 && (i[e] = r[0]), i.removeListener !== void 0 && this.emit("removeListener", e, l || t);
  }
  return this;
};
...
function Ic(n, e, t) {
  ...
  if (r === void 0)
    return [];
  var i = r[e];
  return i === void 0 ? [] : typeof i == "function" ? t ? [i.listener || i] : [i] : t ? Q0(i) : Pc(i, i.length);
}
...
H.listenerCount = function(n, e) {
  return typeof n.listenerCount == "function" ? n.listenerCount(e) : Rc.call(n, e);
};
H.prototype.listenerCount = Rc;
function Rc(n) {
  var e = this._events;
  if (e !== void 0) {
    var t = e[n];
...
function e1(n, e) {
  return new Promise(function(t, r) {
    ...
    Lc(n, e, s, { once: !0 }), e !== "error" && t1(n, i, { once: !0 });
  });
}
function t1(n, e, t) {
  typeof n.on == "function" && Lc(n, "error", e, t);
}
function Lc(n, e, t, r) {
...
var n1 = _s.exports;
const r1 = /* @__PURE__ */ G0(n1);
class i1 extends r1 {
  constructor() {
    super();
    et(this, "editor", null);
    // 自定义事件
    et(this, "customEvents", []);
    // 自定义API
    et(this, "customApis", []);
    et(this, "pluginMap", {});
  }
  ...
  registerPlugin(t, r) {
    if (this._checkPlugin(t) && this.editor) {
      this._saveCustomAttr(t);
      const i = new t(this, this.editor, r || {});
      i.pluginName = t.pluginName, this.pluginMap[t.pluginName] = i, this._bindingApis(i);
    }
  }
  // 绑定代理插件的api
  _bindingApis(t) {
    const { apis: r = [] } = t.constructor || {};
    r.forEach((i) => {
      this[i] = function() {
  ...
  _saveCustomAttr(t) {
    const { events: r = [], apis: i = [] } = t;
    this.customApis = this.customApis.concat(i), this.customEvents = this.customEvents.concat(r);
  }
  _checkPlugin(t) {
    const { pluginName: r, events: i = [], apis: s = [] } = t;
    if (this.pluginMap[r])
      throw new Error(`The ${r} already exists`);
    return i.forEach((o) => {
      if (this.customEvents.some((l) => l === o))
        throw new Error(`Duplicate ${o} name in this ${r}`);
    }), s.forEach((o) => {
      if (this.customApis.some((l) => l === o))
        throw new Error(`Duplicate ${o} name in this ${r}`);
    }), !0;
  }
  get tiptapEditor() {
...
class ds {
  constructor(e, t) {
    et(this, "majorEditor", null);
    et(this, "editor", null);
    this.majorEditor = e, this.editor = t, this.init();
  }
  init() {
    var e;
    (e = this.editor) == null || e.on("focus", ({ editor: t, event: r }) => {
      console.log(t, r, 1233);
    });
  }
  testApi() {
    console.log("TextPlugin testApi");
  }
}
et(ds, "pluginName", "TextPlugin"), et(ds, "apis", ["testApi"]);
const s1 = { class: "vue3-major-editor__root major-editor" }, o1 = /* @__PURE__ */ ps('<section class="cus-header"><h2 class="h2" style="margin-right:0.2em;">Vue3MajorEditor</h2><a href="https://github.com/qiunanya/vue3-major-editor.git" target="_blank"><svg height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github v-align-middle color-fg-default"><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z"></path></svg></a></section>', 1), l1 = Be({
  ...
  setup(n) {
    const e = Wr(null), t = Qc(n, "content"), r = new i1();
    return e.value = new Lg({
      content: t.value,
      extensions: [
        Qp.configure({ types: [Go.name, Za.name] }),
        Go,
        L0
      ]
    }), r.init(e.value), r.registerPlugin(ds), ui("majorEditor", r), ui("editor", e.value), ui("content", t.value), qr(() => {
...
Ml.install = (n) => (n.component("Vue3MajorEditor", Ml), n);
export {
  Ml as Vue3MajorEditor,
  Ml as default
};
